...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoicePublicDetailViewModel', 'model/UserInfoInPublicShow'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InvoicePublicDetailViewModel'), require('./UserInfoInPublicShow'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceInPublicShow = factory(root._.ApiClient, root._.InvoicePublicDetailViewModel, root._.UserInfoInPublicShow);
  }
}(this, function(ApiClient, InvoicePublicDetailViewModel, UserInfoInPublicShow) {
  'use strict';

  /**
   * The InvoiceInPublicShow model module.
   * @module model/InvoiceInPublicShow
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceInPublicShow</code>.
   * @alias module:model/InvoiceInPublicShow
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceInPublicShow</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceInPublicShow} obj Optional instance to populate.
   * @return {module:model/InvoiceInPublicShow} The populated <code>InvoiceInPublicShow</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoice'))
        obj.invoice = InvoicePublicDetailViewModel.constructFromObject(data['invoice']);
      if (data.hasOwnProperty('ownerInfo'))
        obj.ownerInfo = UserInfoInPublicShow.constructFromObject(data['ownerInfo']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InvoicePublicDetailViewModel} invoice
   */
  exports.prototype.invoice = undefined;

  /**
   * @member {module:model/UserInfoInPublicShow} ownerInfo
   */
