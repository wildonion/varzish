...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ListCountViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListCountViewModel model module.
   * @module model/ListCountViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ListCountViewModel</code>.
   * @alias module:model/ListCountViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>ListCountViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListCountViewModel} obj Optional instance to populate.
   * @return {module:model/ListCountViewModel} The populated <code>ListCountViewModel</code> instance.
   */
