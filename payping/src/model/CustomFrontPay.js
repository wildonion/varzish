...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CustomFrontPay = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CustomFrontPay model module.
   * @module model/CustomFrontPay
   * @version v1
   */

  /**
   * Constructs a new <code>CustomFrontPay</code>.
   * @alias module:model/CustomFrontPay
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomFrontPay</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomFrontPay} obj Optional instance to populate.
   * @return {module:model/CustomFrontPay} The populated <code>CustomFrontPay</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('priceColor'))
        obj.priceColor = ApiClient.convertToType(data['priceColor'], 'String');
      if (data.hasOwnProperty('backImageType'))
        obj.backImageType = ApiClient.convertToType(data['backImageType'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.themeColor = undefined;
  ...
  /**
   * @member {String} priceColor
   */
  exports.prototype.priceColor = undefined;

  /**
   * @member {String} backImageType
   */
  exports.prototype.backImageType = undefined;
