...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PayGetViewModel = factory(root._.ApiClient, root._.PUserData, root._.ProductFullDeatilViewModel);
  }
}(this, function(ApiClient, PUserData, ProductFullDeatilViewModel) {
  'use strict';

  /**
   * The PayGetViewModel model module.
   * @module model/PayGetViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PayGetViewModel</code>.
   * @alias module:model/PayGetViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PayGetViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PayGetViewModel} obj Optional instance to populate.
   * @return {module:model/PayGetViewModel} The populated <code>PayGetViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('haveCoupon'))
        obj.haveCoupon = ApiClient.convertToType(data['haveCoupon'], 'Boolean');
      if (data.hasOwnProperty('amount'))
        obj.amount = ApiClient.convertToType(data['amount'], 'String');
      if (data.hasOwnProperty('realAmount'))
        obj.realAmount = ApiClient.convertToType(data['realAmount'], 'String');
  ...
  /**
   * @member {module:model/PayGetViewModel.EmailOptionEnum} emailOption
   */
  exports.prototype.emailOption = undefined;

  /**
   * @member {module:model/PayGetViewModel.PhoneOptionEnum} phoneOption
   */
  exports.prototype.phoneOption = undefined;

  /**
   * @member {module:model/PayGetViewModel.NameOptionEnum} nameOption
   */
  exports.prototype.nameOption = undefined;

  /**
   * @member {module:model/PayGetViewModel.CustomDesOptionEnum} customDesOption
   */
  ...
  /**
   * @member {Boolean} haveCoupon
   */
  exports.prototype.haveCoupon = undefined;
  ...
  /**
   * @member {String} realAmount
   */
  exports.prototype.realAmount = undefined;
