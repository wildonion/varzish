...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.TransactionReportModel = factory(root._.ApiClient, root._.ClientsInfo);
  }
}(this, function(ApiClient, ClientsInfo) {
  'use strict';

  /**
   * The TransactionReportModel model module.
   * @module model/TransactionReportModel
   * @version v1
   */

  /**
   * Constructs a new <code>TransactionReportModel</code>.
   * @alias module:model/TransactionReportModel
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionReportModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionReportModel} obj Optional instance to populate.
   * @return {module:model/TransactionReportModel} The populated <code>TransactionReportModel</code> instance.
   */
   ...
   * @member {module:model/TransactionReportModel.TransactionTypeEnum} transactionType
   */
