...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddressBookEditViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddressBookEditViewModel model module.
   * @module model/AddressBookEditViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>AddressBookEditViewModel</code>.
   * بروزرسانی مشتری
   * @alias module:model/AddressBookEditViewModel
   * @class
  ...
  /**
   * Constructs a <code>AddressBookEditViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressBookEditViewModel} obj Optional instance to populate.
   * @return {module:model/AddressBookEditViewModel} The populated <code>AddressBookEditViewModel</code> instance.
   */
   ...
   * @default false
   */
  exports.prototype.isBusiness = false;
