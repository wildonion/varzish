...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceSetCustomerRequestViewModel = factory(root._.ApiClient, root._.AddressBookCreateViewModel);
  }
}(this, function(ApiClient, AddressBookCreateViewModel) {
  'use strict';

  /**
   * The InvoiceSetCustomerRequestViewModel model module.
   * @module model/InvoiceSetCustomerRequestViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSetCustomerRequestViewModel</code>.
   * @alias module:model/InvoiceSetCustomerRequestViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSetCustomerRequestViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSetCustomerRequestViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceSetCustomerRequestViewModel} The populated <code>InvoiceSetCustomerRequestViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('customer'))
        obj.customer = AddressBookCreateViewModel.constructFromObject(data['customer']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AddressBookCreateViewModel} customer
   */
