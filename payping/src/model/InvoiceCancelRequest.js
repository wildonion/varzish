...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCancelRequest = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceCancelRequest model module.
   * @module model/InvoiceCancelRequest
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCancelRequest</code>.
   * @alias module:model/InvoiceCancelRequest
   * @class
   * @param code {String} 
   */
  ...
  /**
   * Constructs a <code>InvoiceCancelRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCancelRequest} obj Optional instance to populate.
   * @return {module:model/InvoiceCancelRequest} The populated <code>InvoiceCancelRequest</code> instance.
   */
