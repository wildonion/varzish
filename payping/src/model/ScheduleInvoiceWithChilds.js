...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoiceDetailViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InvoiceDetailViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.ScheduleInvoiceWithChilds = factory(root._.ApiClient, root._.InvoiceDetailViewModel);
  }
}(this, function(ApiClient, InvoiceDetailViewModel) {
  'use strict';

  /**
   * The ScheduleInvoiceWithChilds model module.
   * @module model/ScheduleInvoiceWithChilds
   * @version v1
   */

  /**
   * Constructs a new <code>ScheduleInvoiceWithChilds</code>.
   * جزییات کامل فاکتور زمابندی شده
   * @alias module:model/ScheduleInvoiceWithChilds
   * @class
   */
  ...
  /**
   * Constructs a <code>ScheduleInvoiceWithChilds</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ScheduleInvoiceWithChilds} obj Optional instance to populate.
   * @return {module:model/ScheduleInvoiceWithChilds} The populated <code>ScheduleInvoiceWithChilds</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('parentInvoice'))
        obj.parentInvoice = InvoiceDetailViewModel.constructFromObject(data['parentInvoice']);
      if (data.hasOwnProperty('childInvoices'))
        obj.childInvoices = ApiClient.convertToType(data['childInvoices'], [InvoiceDetailViewModel]);
    }
    return obj;
  }

  /**
   * فاکتور زمانبندی والد
   * @member {module:model/InvoiceDetailViewModel} parentInvoice
   */
  exports.prototype.parentInvoice = undefined;

  /**
   * فاکتورهای ساخته شده توسط فاکتور زمابندی والد
   * @member {Array.<module:model/InvoiceDetailViewModel>} childInvoices
   */
  exports.prototype.childInvoices = undefined;
