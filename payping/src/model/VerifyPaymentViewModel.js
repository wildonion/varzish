...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.VerifyPaymentViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The VerifyPaymentViewModel model module.
   * @module model/VerifyPaymentViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>VerifyPaymentViewModel</code>.
   * @alias module:model/VerifyPaymentViewModel
   * @class
   * @param refId {String} شماره فاکتور
   * @param amount {Number} مبلغ تراکنش
   */
  var exports = function(refId, amount) {
    this.refId = refId;
    this.amount = amount;
  };

  /**
   * Constructs a <code>VerifyPaymentViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VerifyPaymentViewModel} obj Optional instance to populate.
   * @return {module:model/VerifyPaymentViewModel} The populated <code>VerifyPaymentViewModel</code> instance.
   */
