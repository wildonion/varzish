...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoiceBillToCreateOrUpdateViewModel', 'model/InvoiceCcToCreateOrUpdateViewModel', 'model/InvoiceItemCreateViewModel', 'model/InvoiceSchulderCreateOrUpdateViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InvoiceBillToCreateOrUpdateViewModel'), require('./InvoiceCcToCreateOrUpdateViewModel'), require('./InvoiceItemCreateViewModel'), require('./InvoiceSchulderCreateOrUpdateViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceCreateScheduleViewModel = factory(root._.ApiClient, root._.InvoiceBillToCreateOrUpdateViewModel, root._.InvoiceCcToCreateOrUpdateViewModel, root._.InvoiceItemCreateViewModel, root._.InvoiceSchulderCreateOrUpdateViewModel);
  }
}(this, function(ApiClient, InvoiceBillToCreateOrUpdateViewModel, InvoiceCcToCreateOrUpdateViewModel, InvoiceItemCreateViewModel, InvoiceSchulderCreateOrUpdateViewModel) {
  'use strict';

  /**
   * The InvoiceCreateScheduleViewModel model module.
   * @module model/InvoiceCreateScheduleViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCreateScheduleViewModel</code>.
   * ثبت فاکتور زمانبندی شده
   * @alias module:model/InvoiceCreateScheduleViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCreateScheduleViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCreateScheduleViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceCreateScheduleViewModel} The populated <code>InvoiceCreateScheduleViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoiceSchulder'))
        obj.invoiceSchulder = InvoiceSchulderCreateOrUpdateViewModel.constructFromObject(data['invoiceSchulder']);
  ...
  /**
   * نوع ثبت:  1 = ارسال  2 = دستی پرداخت شد
   * @member {module:model/InvoiceCreateScheduleViewModel.CreateStatusEnum} createStatus
   */
   ...
   * @member {module:model/InvoiceCreateScheduleViewModel.TotalDiscountTypeEnum} totalDiscountType
   */
   ...
   * @member {module:model/InvoiceSchulderCreateOrUpdateViewModel} invoiceSchulder
   */
