...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CouponResultVM = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CouponResultVM model module.
   * @module model/CouponResultVM
   * @version v1
   */

  /**
   * Constructs a new <code>CouponResultVM</code>.
   * @alias module:model/CouponResultVM
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponResultVM</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponResultVM} obj Optional instance to populate.
   * @return {module:model/CouponResultVM} The populated <code>CouponResultVM</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('newAmount'))
        obj.newAmount = ApiClient.convertToType(data['newAmount'], 'String');
  ...
  /**
   * @member {String} newAmount
   */
  exports.prototype.newAmount = undefined;
