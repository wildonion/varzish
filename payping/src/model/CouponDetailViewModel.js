...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CouponDetailViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CouponDetailViewModel model module.
   * @module model/CouponDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CouponDetailViewModel</code>.
   * @alias module:model/CouponDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponDetailViewModel} obj Optional instance to populate.
   * @return {module:model/CouponDetailViewModel} The populated <code>CouponDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('buyerCounts'))
        obj.buyerCounts = ApiClient.convertToType(data['buyerCounts'], 'Number');
      if (data.hasOwnProperty('buyerSum'))
        obj.buyerSum = ApiClient.convertToType(data['buyerSum'], 'Number');
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CouponDetailViewModel.TypeEnum} type
   */
  ...
  /**
   * @member {String} activeProductCode
   */
  ...
  /**
   * @member {Number} buyerCounts
   */
  exports.prototype.buyerCounts = undefined;

  /**
   * @member {Number} buyerSum
   */
  exports.prototype.buyerSum = undefined;
