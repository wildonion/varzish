...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.UpdateUserCategoryVm = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateUserCategoryVm model module.
   * @module model/UpdateUserCategoryVm
   * @version v1
   */

  /**
   * Constructs a new <code>UpdateUserCategoryVm</code>.
   * @alias module:model/UpdateUserCategoryVm
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateUserCategoryVm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateUserCategoryVm} obj Optional instance to populate.
   * @return {module:model/UpdateUserCategoryVm} The populated <code>UpdateUserCategoryVm</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('subCategoryId'))
        obj.subCategoryId = ApiClient.convertToType(data['subCategoryId'], 'Number');
    }
    return obj;
  }
