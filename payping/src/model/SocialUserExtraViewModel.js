...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.SocialUserExtraViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SocialUserExtraViewModel model module.
   * @module model/SocialUserExtraViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>SocialUserExtraViewModel</code>.
   * @alias module:model/SocialUserExtraViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>SocialUserExtraViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SocialUserExtraViewModel} obj Optional instance to populate.
   * @return {module:model/SocialUserExtraViewModel} The populated <code>SocialUserExtraViewModel</code> instance.
   */
