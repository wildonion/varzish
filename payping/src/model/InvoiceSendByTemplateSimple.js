...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressBookCreateViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddressBookCreateViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceSendByTemplateSimple = factory(root._.ApiClient, root._.AddressBookCreateViewModel);
  }
}(this, function(ApiClient, AddressBookCreateViewModel) {
  'use strict';

  /**
   * The InvoiceSendByTemplateSimple model module.
   * @module model/InvoiceSendByTemplateSimple
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSendByTemplateSimple</code>.
   * ثبت فاکتور با استفاده از قالب فاکتور
   * @alias module:model/InvoiceSendByTemplateSimple
   * @class
  ...
  /**
   * Constructs a <code>InvoiceSendByTemplateSimple</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSendByTemplateSimple} obj Optional instance to populate.
   * @return {module:model/InvoiceSendByTemplateSimple} The populated <code>InvoiceSendByTemplateSimple</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('addressBook'))
        obj.addressBook = AddressBookCreateViewModel.constructFromObject(data['addressBook']);
    }
    return obj;
  }
  ...
  /**
   * مشخصات مشتری
   * @member {module:model/AddressBookCreateViewModel} addressBook
   */
  exports.prototype.addressBook = undefined;
