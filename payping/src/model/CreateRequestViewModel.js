...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CreateRequestViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateRequestViewModel model module.
   * @module model/CreateRequestViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CreateRequestViewModel</code>.
   * @alias module:model/CreateRequestViewModel
   * @class
  ...
  /**
   * Constructs a <code>CreateRequestViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateRequestViewModel} obj Optional instance to populate.
   * @return {module:model/CreateRequestViewModel} The populated <code>CreateRequestViewModel</code> instance.
   */
  ...
  /**
   * نام کاربری درخواست کننده (در صورت وجود)
