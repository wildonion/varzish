...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CreateMultiRequestViewModel = factory(root._.ApiClient, root._.MultiPayPair);
  }
}(this, function(ApiClient, MultiPayPair) {
  'use strict';

  /**
   * The CreateMultiRequestViewModel model module.
   * @module model/CreateMultiRequestViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CreateMultiRequestViewModel</code>.
   * @alias module:model/CreateMultiRequestViewModel
   * @class
  ...
  /**
   * Constructs a <code>CreateMultiRequestViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateMultiRequestViewModel} obj Optional instance to populate.
   * @return {module:model/CreateMultiRequestViewModel} The populated <code>CreateMultiRequestViewModel</code> instance.
   */
