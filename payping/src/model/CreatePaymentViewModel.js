...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CreatePaymentViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreatePaymentViewModel model module.
   * @module model/CreatePaymentViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CreatePaymentViewModel</code>.
   * @alias module:model/CreatePaymentViewModel
   * @class
   * @param amount {Number} مبلغ
   * @param returnUrl {String} آدرس صفحه برگشت
   */
  var exports = function(amount, returnUrl) {
    this.amount = amount;
    this.returnUrl = returnUrl;
  };

  /**
   * Constructs a <code>CreatePaymentViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreatePaymentViewModel} obj Optional instance to populate.
   * @return {module:model/CreatePaymentViewModel} The populated <code>CreatePaymentViewModel</code> instance.
   */
