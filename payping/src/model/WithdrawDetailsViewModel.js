...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.WithdrawDetailsViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The WithdrawDetailsViewModel model module.
   * @module model/WithdrawDetailsViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>WithdrawDetailsViewModel</code>.
   * @alias module:model/WithdrawDetailsViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>WithdrawDetailsViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WithdrawDetailsViewModel} obj Optional instance to populate.
   * @return {module:model/WithdrawDetailsViewModel} The populated <code>WithdrawDetailsViewModel</code> instance.
   */
