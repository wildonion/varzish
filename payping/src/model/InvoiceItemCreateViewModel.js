...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceItemCreateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceItemCreateViewModel model module.
   * @module model/InvoiceItemCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceItemCreateViewModel</code>.
   * ثبت آیتم مالی فاکتور
   * @alias module:model/InvoiceItemCreateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceItemCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceItemCreateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceItemCreateViewModel} The populated <code>InvoiceItemCreateViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceItemCreateViewModel.DiscountTypeEnum} discountType
   */
