...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceBillToCreateOrUpdateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceBillToCreateOrUpdateViewModel model module.
   * @module model/InvoiceBillToCreateOrUpdateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceBillToCreateOrUpdateViewModel</code>.
   * ثبت یا بروزرسانی مشتری
   * @alias module:model/InvoiceBillToCreateOrUpdateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceBillToCreateOrUpdateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceBillToCreateOrUpdateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceBillToCreateOrUpdateViewModel} The populated <code>InvoiceBillToCreateOrUpdateViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('addressBookCode'))
        obj.addressBookCode = ApiClient.convertToType(data['addressBookCode'], 'String');
    }
    return obj;
  }
  ...
  /**
   * کلید یکتای مشتری
   * @member {String} addressBookCode
   * @default ''
   */
  exports.prototype.addressBookCode = '';
