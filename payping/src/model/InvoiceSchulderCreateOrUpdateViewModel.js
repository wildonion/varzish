...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceSchulderCreateOrUpdateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceSchulderCreateOrUpdateViewModel model module.
   * @module model/InvoiceSchulderCreateOrUpdateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSchulderCreateOrUpdateViewModel</code>.
   * ثبت اطلاعات زمانبندی فاکتور
   * @alias module:model/InvoiceSchulderCreateOrUpdateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSchulderCreateOrUpdateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSchulderCreateOrUpdateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceSchulderCreateOrUpdateViewModel} The populated <code>InvoiceSchulderCreateOrUpdateViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceSchulderCreateOrUpdateViewModel.SchulderTypeEnum} schulderType
   * @default SchulderTypeEnum._0
   */
  exports.prototype.schulderType = 0;

  /**
   * نوع پایان زمانبندی:  0 = پس از ساخت X فاکتور  1 = پایان دادن به ساخت فاکتور در تاریخ X  2 = ساخت نامحدود فاکتور
   * @member {module:model/InvoiceSchulderCreateOrUpdateViewModel.DueTypeEnum} dueType
   * @default DueTypeEnum._0
   */
  exports.prototype.dueType = 0;
  ...
  exports.SchulderTypeEnum = SchulderTypeEnum;
  ...
  exports.DueTypeEnum = DueTypeEnum;
