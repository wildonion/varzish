...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddressBookCreateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddressBookCreateViewModel model module.
   * @module model/AddressBookCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>AddressBookCreateViewModel</code>.
   * ثبت مشتری جدید
   * @alias module:model/AddressBookCreateViewModel
   * @class
  ...
  /**
   * Constructs a <code>AddressBookCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressBookCreateViewModel} obj Optional instance to populate.
   * @return {module:model/AddressBookCreateViewModel} The populated <code>AddressBookCreateViewModel</code> instance.
   */
