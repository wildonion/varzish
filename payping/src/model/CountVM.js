...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CountVM = factory(root._.ApiClient);
  }
   ...
   * @module model/CountVM
   * @version v1
   */

  /**
   * Constructs a new <code>CountVM</code>.
   * @alias module:model/CountVM
   * @class
   */
   ...
   * @param {module:model/CountVM} obj Optional instance to populate.
   * @return {module:model/CountVM} The populated <code>CountVM</code> instance.
   */
