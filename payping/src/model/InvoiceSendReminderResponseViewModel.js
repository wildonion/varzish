...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceSendReminderResponseViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceSendReminderResponseViewModel model module.
   * @module model/InvoiceSendReminderResponseViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSendReminderResponseViewModel</code>.
   * بازگشت مشخصات ارسال یادآوری فاکتور
   * @alias module:model/InvoiceSendReminderResponseViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSendReminderResponseViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSendReminderResponseViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceSendReminderResponseViewModel} The populated <code>InvoiceSendReminderResponseViewModel</code> instance.
   */
