...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceSubSchulderDetailViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceSubSchulderDetailViewModel model module.
   * @module model/InvoiceSubSchulderDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSubSchulderDetailViewModel</code>.
   * جزییات دستور ساخت فاکتورهای زمانبندی شده و وضعیت آن ها
   * @alias module:model/InvoiceSubSchulderDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSubSchulderDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSubSchulderDetailViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceSubSchulderDetailViewModel} The populated <code>InvoiceSubSchulderDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mustBeCreateInDateTime'))
        obj.mustBeCreateInDateTime = ApiClient.convertToType(data['mustBeCreateInDateTime'], 'Date');
      if (data.hasOwnProperty('deActiveDateTime'))
        obj.deActiveDateTime = ApiClient.convertToType(data['deActiveDateTime'], 'Date');
      if (data.hasOwnProperty('isInvoiceCreated'))
        obj.isInvoiceCreated = ApiClient.convertToType(data['isInvoiceCreated'], 'Boolean');
      if (data.hasOwnProperty('isActive'))
        obj.isActive = ApiClient.convertToType(data['isActive'], 'Boolean');
      if (data.hasOwnProperty('invoiceCode'))
        obj.invoiceCode = ApiClient.convertToType(data['invoiceCode'], 'String');
    }
    return obj;
  }

  /**
   * تاریخ سررسید فاکتوری که باید ساخته شود
   * @member {Date} dueDate
   */
  exports.prototype.dueDate = undefined;

  /**
   * تاریخ روزی که فاکتور باید ساخته شود
   * @member {Date} mustBeCreateInDateTime
   */
  exports.prototype.mustBeCreateInDateTime = undefined;

  /**
   * تاریخ غیر فعال شدن ساخت فاکتور
   * @member {Date} deActiveDateTime
   */
  exports.prototype.deActiveDateTime = undefined;

  /**
   * ساخته شد = true, در صف انتظار= false
   * @member {Boolean} isInvoiceCreated
   */
  exports.prototype.isInvoiceCreated = undefined;

  /**
   * فعال بود = true, غیر فعال = false
   * @member {Boolean} isActive
   */
  exports.prototype.isActive = undefined;

  /**
   * کلید یکتا فاکتور ساخته شده
   * @member {String} invoiceCode
   */
  exports.prototype.invoiceCode = undefined;
