...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoicePublicDetailViewModel = factory(root._.ApiClient, root._.InvoiceBillToDetailViewModel, root._.InvoiceCcToDetailViewModel, root._.InvoiceItemDetailViewModel, root._.InvoiceSchulderDetailViewModel);
  }
  ...
  /**
   * The InvoicePublicDetailViewModel model module.
   * @module model/InvoicePublicDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoicePublicDetailViewModel</code>.
   * جزییات فاکتور به صورت عمومی
   * @alias module:model/InvoicePublicDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicePublicDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicePublicDetailViewModel} obj Optional instance to populate.
   * @return {module:model/InvoicePublicDetailViewModel} The populated <code>InvoicePublicDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('expiredDateTime'))
        obj.expiredDateTime = ApiClient.convertToType(data['expiredDateTime'], 'Date');
  ...
  /**
   * تاریخ معوق شدن
   * @member {Date} expiredDateTime
   */
  exports.prototype.expiredDateTime = undefined;
   ...
   * @member {module:model/InvoicePublicDetailViewModel.StatusEnum} status
   */
   ...
   * @member {module:model/InvoicePublicDetailViewModel.TotalDiscountTypeEnum} totalDiscountType
   */
