...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PersonalInfoViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PersonalInfoViewModel model module.
   * @module model/PersonalInfoViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PersonalInfoViewModel</code>.
   * @alias module:model/PersonalInfoViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PersonalInfoViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PersonalInfoViewModel} obj Optional instance to populate.
   * @return {module:model/PersonalInfoViewModel} The populated <code>PersonalInfoViewModel</code> instance.
   */
