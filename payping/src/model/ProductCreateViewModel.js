...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ProductCreateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ProductCreateViewModel model module.
   * @module model/ProductCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ProductCreateViewModel</code>.
   * @alias module:model/ProductCreateViewModel
   * @class
   * @param title {String} 
   */
  ...
  /**
   * Constructs a <code>ProductCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductCreateViewModel} obj Optional instance to populate.
   * @return {module:model/ProductCreateViewModel} The populated <code>ProductCreateViewModel</code> instance.
   */
