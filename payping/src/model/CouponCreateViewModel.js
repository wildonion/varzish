...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CouponCreateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CouponCreateViewModel model module.
   * @module model/CouponCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CouponCreateViewModel</code>.
   * @alias module:model/CouponCreateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponCreateViewModel} obj Optional instance to populate.
   * @return {module:model/CouponCreateViewModel} The populated <code>CouponCreateViewModel</code> instance.
   */
  ...
  /**
   * @member {module:model/CouponCreateViewModel.TypeEnum} type
   */
