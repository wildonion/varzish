...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CategoryMinorDetailVM = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CategoryMinorDetailVM model module.
   * @module model/CategoryMinorDetailVM
   * @version v1
   */

  /**
   * Constructs a new <code>CategoryMinorDetailVM</code>.
   * @alias module:model/CategoryMinorDetailVM
   * @class
   */
  ...
  /**
   * Constructs a <code>CategoryMinorDetailVM</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CategoryMinorDetailVM} obj Optional instance to populate.
   * @return {module:model/CategoryMinorDetailVM} The populated <code>CategoryMinorDetailVM</code> instance.
   */
