...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PermanentListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PermanentListItemViewModel model module.
   * @module model/PermanentListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PermanentListItemViewModel</code>.
   * @alias module:model/PermanentListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PermanentListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PermanentListItemViewModel} obj Optional instance to populate.
   * @return {module:model/PermanentListItemViewModel} The populated <code>PermanentListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('itemIsActive'))
        obj.itemIsActive = ApiClient.convertToType(data['itemIsActive'], 'Boolean');
      if (data.hasOwnProperty('itemIsAvailable'))
        obj.itemIsAvailable = ApiClient.convertToType(data['itemIsAvailable'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PermanentListItemViewModel.PermanentTypeEnum} permanentType
   */
  ...
  /**
   * @member {Boolean} itemIsActive
   */
  exports.prototype.itemIsActive = undefined;

  /**
   * @member {Boolean} itemIsAvailable
   */
  exports.prototype.itemIsAvailable = undefined;
