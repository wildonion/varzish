...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomFrontPay', 'model/PSocialUserExtraViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomFrontPay'), require('./PSocialUserExtraViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.PUserData = factory(root._.ApiClient, root._.CustomFrontPay, root._.PSocialUserExtraViewModel);
  }
}(this, function(ApiClient, CustomFrontPay, PSocialUserExtraViewModel) {
  'use strict';

  /**
   * The PUserData model module.
   * @module model/PUserData
   * @version v1
   */

  /**
   * Constructs a new <code>PUserData</code>.
   * @alias module:model/PUserData
   * @class
   */
  ...
  /**
   * Constructs a <code>PUserData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PUserData} obj Optional instance to populate.
   * @return {module:model/PUserData} The populated <code>PUserData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('verifyType'))
        obj.verifyType = ApiClient.convertToType(data['verifyType'], 'String');
      if (data.hasOwnProperty('socials'))
        obj.socials = PSocialUserExtraViewModel.constructFromObject(data['socials']);
      if (data.hasOwnProperty('customFrontPay'))
        obj.customFrontPay = CustomFrontPay.constructFromObject(data['customFrontPay']);
      if (data.hasOwnProperty('maxPaymntAmount'))
        obj.maxPaymntAmount = ApiClient.convertToType(data['maxPaymntAmount'], 'Number');
    }
    return obj;
  }
  ...
  /**
   * @member {String} verifyType
   */
  exports.prototype.verifyType = undefined;

  /**
   * @member {module:model/PSocialUserExtraViewModel} socials
   */
  exports.prototype.socials = undefined;

  /**
   * @member {module:model/CustomFrontPay} customFrontPay
   */
  exports.prototype.customFrontPay = undefined;

  /**
   * @member {Number} maxPaymntAmount
   */
  exports.prototype.maxPaymntAmount = undefined;
