...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoicePdfResponseViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoicePdfResponseViewModel model module.
   * @module model/InvoicePdfResponseViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoicePdfResponseViewModel</code>.
   * مشخصات بازگشت درخواست فایل پی دی اف فاکتور
   * @alias module:model/InvoicePdfResponseViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoicePdfResponseViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoicePdfResponseViewModel} obj Optional instance to populate.
   * @return {module:model/InvoicePdfResponseViewModel} The populated <code>InvoicePdfResponseViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('fileAddress'))
        obj.fileAddress = ApiClient.convertToType(data['fileAddress'], 'String');
    }
    return obj;
  }

  /**
   * موفقیت آمیز بودن درخواست = true, ناموفق بودن = false
  ...
  /**
   * آدرس فایل
   * @member {String} fileAddress
   */
  exports.prototype.fileAddress = undefined;
