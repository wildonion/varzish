...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCreateViewModel = factory(root._.ApiClient, root._.InvoiceBillToCreateOrUpdateViewModel, root._.InvoiceCcToCreateOrUpdateViewModel, root._.InvoiceItemCreateViewModel);
  }
  ...
  /**
   * The InvoiceCreateViewModel model module.
   * @module model/InvoiceCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCreateViewModel</code>.
   * ثبت فاکتور ساده
   * @alias module:model/InvoiceCreateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCreateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceCreateViewModel} The populated <code>InvoiceCreateViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceCreateViewModel.CreateStatusEnum} createStatus
   */
   ...
   * @member {module:model/InvoiceCreateViewModel.TotalDiscountTypeEnum} totalDiscountType
   */
