...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.IPosPayResult = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The IPosPayResult model module.
   * @module model/IPosPayResult
   * @version v1
   */

  /**
   * Constructs a new <code>IPosPayResult</code>.
   * @alias module:model/IPosPayResult
   * @class
   */
  ...
  /**
   * Constructs a <code>IPosPayResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IPosPayResult} obj Optional instance to populate.
   * @return {module:model/IPosPayResult} The populated <code>IPosPayResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('itd'))
        obj.itd = ApiClient.convertToType(data['itd'], 'Number');
   ...
   * @member {Number} itd
   */
  exports.prototype.itd = undefined;
