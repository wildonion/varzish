...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceTemplateListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceTemplateListItemViewModel model module.
   * @module model/InvoiceTemplateListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceTemplateListItemViewModel</code>.
   * مشخصات قالب فاکتور
   * @alias module:model/InvoiceTemplateListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceTemplateListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceTemplateListItemViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceTemplateListItemViewModel} The populated <code>InvoiceTemplateListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hasSchulder'))
        obj.hasSchulder = ApiClient.convertToType(data['hasSchulder'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * دارای زمانبندی = true, بدون زمانبندی = false
   * @member {Boolean} hasSchulder
   */
  exports.prototype.hasSchulder = undefined;
