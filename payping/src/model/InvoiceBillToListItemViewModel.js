...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressBookListItemViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddressBookListItemViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceBillToListItemViewModel = factory(root._.ApiClient, root._.AddressBookListItemViewModel);
  }
}(this, function(ApiClient, AddressBookListItemViewModel) {
  'use strict';

  /**
   * The InvoiceBillToListItemViewModel model module.
   * @module model/InvoiceBillToListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceBillToListItemViewModel</code>.
   * مشتری یا پرداخت کننده
   * @alias module:model/InvoiceBillToListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceBillToListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceBillToListItemViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceBillToListItemViewModel} The populated <code>InvoiceBillToListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('addressBook'))
        obj.addressBook = AddressBookListItemViewModel.constructFromObject(data['addressBook']);
    }
    return obj;
  }

  /**
   * مشخصات مشتری یا پرداخت کننده
   * @member {module:model/AddressBookListItemViewModel} addressBook
   */
