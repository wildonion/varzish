...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddressBookListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddressBookListItemViewModel model module.
   * @module model/AddressBookListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>AddressBookListItemViewModel</code>.
   * مشخصات مشتری
   * @alias module:model/AddressBookListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>AddressBookListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressBookListItemViewModel} obj Optional instance to populate.
   * @return {module:model/AddressBookListItemViewModel} The populated <code>AddressBookListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isBusiness'))
        obj.isBusiness = ApiClient.convertToType(data['isBusiness'], 'String');
    }
    return obj;
  }
