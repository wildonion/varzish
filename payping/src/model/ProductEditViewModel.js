...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ProductEditViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ProductEditViewModel model module.
   * @module model/ProductEditViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ProductEditViewModel</code>.
   * @alias module:model/ProductEditViewModel
   * @class
   * @param title {String} 
   * @param amount {Number} 
   */
  var exports = function(title, amount) {
    this.title = title;
    this.amount = amount;
  };

  /**
   * Constructs a <code>ProductEditViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductEditViewModel} obj Optional instance to populate.
   * @return {module:model/ProductEditViewModel} The populated <code>ProductEditViewModel</code> instance.
   */
