...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressBookDetailViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddressBookDetailViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceBillToDetailViewModel = factory(root._.ApiClient, root._.AddressBookDetailViewModel);
  }
}(this, function(ApiClient, AddressBookDetailViewModel) {
  'use strict';

  /**
   * The InvoiceBillToDetailViewModel model module.
   * @module model/InvoiceBillToDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceBillToDetailViewModel</code>.
   * مشتری یا پرداخت کننده
   * @alias module:model/InvoiceBillToDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceBillToDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceBillToDetailViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceBillToDetailViewModel} The populated <code>InvoiceBillToDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('addressBook'))
        obj.addressBook = AddressBookDetailViewModel.constructFromObject(data['addressBook']);
    }
    return obj;
  }
   ...
   * @member {module:model/AddressBookDetailViewModel} addressBook
   */
