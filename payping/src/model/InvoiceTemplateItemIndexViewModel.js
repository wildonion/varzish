...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceTemplateItemIndexViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceTemplateItemIndexViewModel model module.
   * @module model/InvoiceTemplateItemIndexViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceTemplateItemIndexViewModel</code>.
   * جزییات آیتم مالی قالب فاکتور
   * @alias module:model/InvoiceTemplateItemIndexViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceTemplateItemIndexViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceTemplateItemIndexViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceTemplateItemIndexViewModel} The populated <code>InvoiceTemplateItemIndexViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceTemplateItemIndexViewModel.DiscountTypeEnum} discountType
   */
  ...
  /**
   * مبلغ فی - مبلغ تخفیف) * تعداد = مجموع)
