...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddPersonalinfoVm = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddPersonalinfoVm model module.
   * @module model/AddPersonalinfoVm
   * @version v1
   */

  /**
   * Constructs a new <code>AddPersonalinfoVm</code>.
   * @alias module:model/AddPersonalinfoVm
   * @class
   */
  ...
  /**
   * Constructs a <code>AddPersonalinfoVm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddPersonalinfoVm} obj Optional instance to populate.
   * @return {module:model/AddPersonalinfoVm} The populated <code>AddPersonalinfoVm</code> instance.
   */
