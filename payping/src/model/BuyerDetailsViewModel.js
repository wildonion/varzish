...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProductInfo'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.BuyerDetailsViewModel = factory(root._.ApiClient, root._.ProductInfo);
  }
}(this, function(ApiClient, ProductInfo) {
  'use strict';

  /**
   * The BuyerDetailsViewModel model module.
   * @module model/BuyerDetailsViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>BuyerDetailsViewModel</code>.
   * @alias module:model/BuyerDetailsViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>BuyerDetailsViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BuyerDetailsViewModel} obj Optional instance to populate.
   * @return {module:model/BuyerDetailsViewModel} The populated <code>BuyerDetailsViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('permanLinkCode'))
        obj.permanLinkCode = ApiClient.convertToType(data['permanLinkCode'], 'String');
      ...
      if (data.hasOwnProperty('payerId'))
        obj.payerId = ApiClient.convertToType(data['payerId'], 'Number');
  ...
  /**
   * @member {String} permanLinkCode
   */
  exports.prototype.permanLinkCode = undefined;
   ...
   */
  exports.prototype.campaignCode = undefined;
