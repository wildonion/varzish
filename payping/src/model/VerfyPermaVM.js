...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.VerfyPermaVM = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The VerfyPermaVM model module.
   * @module model/VerfyPermaVM
   * @version v1
   */

  /**
   * Constructs a new <code>VerfyPermaVM</code>.
   * @alias module:model/VerfyPermaVM
   * @class
   */
  ...
  /**
   * Constructs a <code>VerfyPermaVM</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VerfyPermaVM} obj Optional instance to populate.
   * @return {module:model/VerfyPermaVM} The populated <code>VerfyPermaVM</code> instance.
   */
