...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCcToListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceCcToListItemViewModel model module.
   * @module model/InvoiceCcToListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCcToListItemViewModel</code>.
   * CC
   * @alias module:model/InvoiceCcToListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCcToListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCcToListItemViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceCcToListItemViewModel} The populated <code>InvoiceCcToListItemViewModel</code> instance.
   */
