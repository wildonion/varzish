...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PermanentDetailViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PermanentDetailViewModel model module.
   * @module model/PermanentDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PermanentDetailViewModel</code>.
   * @alias module:model/PermanentDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PermanentDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PermanentDetailViewModel} obj Optional instance to populate.
   * @return {module:model/PermanentDetailViewModel} The populated <code>PermanentDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('qrLink'))
        obj.qrLink = ApiClient.convertToType(data['qrLink'], 'String');
  ...
  /**
   * @member {module:model/PermanentDetailViewModel.EmailOptionEnum} emailOption
   */
  exports.prototype.emailOption = undefined;

  /**
   * @member {module:model/PermanentDetailViewModel.PhoneOptionEnum} phoneOption
   */
  exports.prototype.phoneOption = undefined;

  /**
   * @member {module:model/PermanentDetailViewModel.NameOptionEnum} nameOption
   */
  exports.prototype.nameOption = undefined;

  /**
   * @member {module:model/PermanentDetailViewModel.CustomDesOptionEnum} customDesOption
   */
  ...
  /**
   * @member {String} qrLink
   */
  exports.prototype.qrLink = undefined;

  /**
   * @member {module:model/PermanentDetailViewModel.PermanentTypeEnum} permanentType
   */
