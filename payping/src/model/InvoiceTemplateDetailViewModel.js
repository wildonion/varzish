...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InvoiceTemplateItemIndexViewModel', 'model/InvoiceTemplateSchulderIndexViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InvoiceTemplateItemIndexViewModel'), require('./InvoiceTemplateSchulderIndexViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.InvoiceTemplateDetailViewModel = factory(root._.ApiClient, root._.InvoiceTemplateItemIndexViewModel, root._.InvoiceTemplateSchulderIndexViewModel);
  }
}(this, function(ApiClient, InvoiceTemplateItemIndexViewModel, InvoiceTemplateSchulderIndexViewModel) {
  'use strict';

  /**
   * The InvoiceTemplateDetailViewModel model module.
   * @module model/InvoiceTemplateDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceTemplateDetailViewModel</code>.
   * جزییات قالب فاکتور
   * @alias module:model/InvoiceTemplateDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceTemplateDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceTemplateDetailViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceTemplateDetailViewModel} The populated <code>InvoiceTemplateDetailViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoiceTemplateItems'))
        obj.invoiceTemplateItems = ApiClient.convertToType(data['invoiceTemplateItems'], [InvoiceTemplateItemIndexViewModel]);
      if (data.hasOwnProperty('invoiceSchulder'))
        obj.invoiceSchulder = InvoiceTemplateSchulderIndexViewModel.constructFromObject(data['invoiceSchulder']);
   ...
   * @member {module:model/InvoiceTemplateDetailViewModel.TotalDiscountTypeEnum} totalDiscountType
   */
   ...
   * @member {Array.<module:model/InvoiceTemplateItemIndexViewModel>} invoiceTemplateItems
   */
  exports.prototype.invoiceTemplateItems = undefined;

  /**
   * ارسال زماندار که رابطه (یک به یک) یا (یک به صفر) دارد
   * @member {module:model/InvoiceTemplateSchulderIndexViewModel} invoiceSchulder
   */
