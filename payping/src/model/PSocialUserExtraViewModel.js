...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PSocialUserExtraViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PSocialUserExtraViewModel model module.
   * @module model/PSocialUserExtraViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PSocialUserExtraViewModel</code>.
   * @alias module:model/PSocialUserExtraViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PSocialUserExtraViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PSocialUserExtraViewModel} obj Optional instance to populate.
   * @return {module:model/PSocialUserExtraViewModel} The populated <code>PSocialUserExtraViewModel</code> instance.
   */
