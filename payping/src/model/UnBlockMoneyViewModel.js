...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.UnBlockMoneyViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UnBlockMoneyViewModel model module.
   * @module model/UnBlockMoneyViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>UnBlockMoneyViewModel</code>.
   * @alias module:model/UnBlockMoneyViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>UnBlockMoneyViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnBlockMoneyViewModel} obj Optional instance to populate.
   * @return {module:model/UnBlockMoneyViewModel} The populated <code>UnBlockMoneyViewModel</code> instance.
   */
