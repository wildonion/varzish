...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.EditLocalInfoesViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EditLocalInfoesViewModel model module.
   * @module model/EditLocalInfoesViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>EditLocalInfoesViewModel</code>.
   * @alias module:model/EditLocalInfoesViewModel
   * @class
   * @param state {String} 
   * @param city {String} 
   ...
   */
  var exports = function(state, city, address, postalCode) {
    this.state = state;
    this.city = city;
  ...
  /**
   * Constructs a <code>EditLocalInfoesViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EditLocalInfoesViewModel} obj Optional instance to populate.
   * @return {module:model/EditLocalInfoesViewModel} The populated <code>EditLocalInfoesViewModel</code> instance.
   */
