...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ProductDetailViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ProductDetailViewModel model module.
   * @module model/ProductDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ProductDetailViewModel</code>.
   * @alias module:model/ProductDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>ProductDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductDetailViewModel} obj Optional instance to populate.
   * @return {module:model/ProductDetailViewModel} The populated <code>ProductDetailViewModel</code> instance.
   */
