...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddBusinessinfoVm = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddBusinessinfoVm model module.
   * @module model/AddBusinessinfoVm
   * @version v1
   */

  /**
   * Constructs a new <code>AddBusinessinfoVm</code>.
   * @alias module:model/AddBusinessinfoVm
   * @class
   */
  ...
  /**
   * Constructs a <code>AddBusinessinfoVm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddBusinessinfoVm} obj Optional instance to populate.
   * @return {module:model/AddBusinessinfoVm} The populated <code>AddBusinessinfoVm</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isBusinessMoreThan6Mil'))
        obj.isBusinessMoreThan6Mil = ApiClient.convertToType(data['isBusinessMoreThan6Mil'], 'Boolean');
      if (data.hasOwnProperty('isOfficialSubmited'))
        obj.isOfficialSubmited = ApiClient.convertToType(data['isOfficialSubmited'], 'Boolean');
      if (data.hasOwnProperty('bNationalCode'))
        obj.bNationalCode = ApiClient.convertToType(data['bNationalCode'], 'String');
      if (data.hasOwnProperty('sabtNumber'))
        obj.sabtNumber = ApiClient.convertToType(data['sabtNumber'], 'String');
      if (data.hasOwnProperty('economicCode'))
        obj.economicCode = ApiClient.convertToType(data['economicCode'], 'String');
    }
    return obj;
  }
  ...
  /**
   * @member {Boolean} isBusinessMoreThan6Mil
   */
  exports.prototype.isBusinessMoreThan6Mil = undefined;

  /**
   * @member {Boolean} isOfficialSubmited
   */
  exports.prototype.isOfficialSubmited = undefined;

  /**
   * @member {String} bNationalCode
   */
  exports.prototype.bNationalCode = undefined;

  /**
   * @member {String} sabtNumber
   */
  exports.prototype.sabtNumber = undefined;

  /**
   * @member {String} economicCode
   */
  exports.prototype.economicCode = undefined;
