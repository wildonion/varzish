...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceTemplateCreateViewModel = factory(root._.ApiClient, root._.InvoiceTemplateItemCreateViewModel, root._.InvoiceTemplateSchulderCreateOrUpdateViewModel);
  }
}(this, function(ApiClient, InvoiceTemplateItemCreateViewModel, InvoiceTemplateSchulderCreateOrUpdateViewModel) {
  'use strict';

  /**
   * The InvoiceTemplateCreateViewModel model module.
   * @module model/InvoiceTemplateCreateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceTemplateCreateViewModel</code>.
   * قالب فاکتور جدید
   * @alias module:model/InvoiceTemplateCreateViewModel
   * @class
   * @param templateName {String} عنوان
   */
  var exports = function(templateName) {
    this.templateName = templateName;
  };

  /**
   * Constructs a <code>InvoiceTemplateCreateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceTemplateCreateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceTemplateCreateViewModel} The populated <code>InvoiceTemplateCreateViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceTemplateCreateViewModel.TotalDiscountTypeEnum} totalDiscountType
   */
