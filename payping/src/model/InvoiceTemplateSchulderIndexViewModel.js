...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceTemplateSchulderIndexViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceTemplateSchulderIndexViewModel model module.
   * @module model/InvoiceTemplateSchulderIndexViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceTemplateSchulderIndexViewModel</code>.
   * جزییات مشخصات ساخت زمانبندی قالب فاکتور
   * @alias module:model/InvoiceTemplateSchulderIndexViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceTemplateSchulderIndexViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceTemplateSchulderIndexViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceTemplateSchulderIndexViewModel} The populated <code>InvoiceTemplateSchulderIndexViewModel</code> instance.
   */
   ...
   * @member {module:model/InvoiceTemplateSchulderIndexViewModel.SchulderTypeEnum} schulderType
   ...
   * @member {module:model/InvoiceTemplateSchulderIndexViewModel.DueTypeEnum} dueType
