...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.MultiPayPair = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MultiPayPair model module.
   * @module model/MultiPayPair
   * @version v1
   */

  /**
   * Constructs a new <code>MultiPayPair</code>.
   * @alias module:model/MultiPayPair
   * @class
   * @param amount {Number} مبلغ
   * @param userIdentity {String} نام کاربری/ایمیل کاربری
   */
  var exports = function(amount, userIdentity) {
    this.amount = amount;
    this.userIdentity = userIdentity;
  };

  /**
   * Constructs a <code>MultiPayPair</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MultiPayPair} obj Optional instance to populate.
   * @return {module:model/MultiPayPair} The populated <code>MultiPayPair</code> instance.
   */
