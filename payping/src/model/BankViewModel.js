...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.BankViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BankViewModel model module.
   * @module model/BankViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>BankViewModel</code>.
   * @alias module:model/BankViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>BankViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BankViewModel} obj Optional instance to populate.
   * @return {module:model/BankViewModel} The populated <code>BankViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shabaVerifyed'))
        obj.shabaVerifyed = ApiClient.convertToType(data['shabaVerifyed'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * @member {Boolean} shabaVerifyed
   */
  exports.prototype.shabaVerifyed = undefined;
