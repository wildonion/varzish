...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCcToDetailViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceCcToDetailViewModel model module.
   * @module model/InvoiceCcToDetailViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCcToDetailViewModel</code>.
   * CC
   * @alias module:model/InvoiceCcToDetailViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCcToDetailViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCcToDetailViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceCcToDetailViewModel} The populated <code>InvoiceCcToDetailViewModel</code> instance.
   */
