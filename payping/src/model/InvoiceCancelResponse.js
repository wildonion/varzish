...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCancelResponse = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceCancelResponse model module.
   * @module model/InvoiceCancelResponse
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCancelResponse</code>.
   * بازگشت مشخصات درخواست لغو فاکتور
   * @alias module:model/InvoiceCancelResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCancelResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCancelResponse} obj Optional instance to populate.
   * @return {module:model/InvoiceCancelResponse} The populated <code>InvoiceCancelResponse</code> instance.
   */
