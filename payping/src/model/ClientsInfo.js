...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ClientsInfo = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ClientsInfo model module.
   * @module model/ClientsInfo
   * @version v1
   */

  /**
   * Constructs a new <code>ClientsInfo</code>.
   * @alias module:model/ClientsInfo
   * @class
   */
  ...
  /**
   * Constructs a <code>ClientsInfo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ClientsInfo} obj Optional instance to populate.
   * @return {module:model/ClientsInfo} The populated <code>ClientsInfo</code> instance.
   */
