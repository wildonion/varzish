...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PermanentEditViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PermanentEditViewModel model module.
   * @module model/PermanentEditViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PermanentEditViewModel</code>.
   * @alias module:model/PermanentEditViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PermanentEditViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PermanentEditViewModel} obj Optional instance to populate.
   * @return {module:model/PermanentEditViewModel} The populated <code>PermanentEditViewModel</code> instance.
   */
  ...
  /**
   * @member {module:model/PermanentEditViewModel.EmailOptionEnum} emailOption
   */
  exports.prototype.emailOption = undefined;

  /**
   * @member {module:model/PermanentEditViewModel.PhoneOptionEnum} phoneOption
   */
  exports.prototype.phoneOption = undefined;

  /**
   * @member {module:model/PermanentEditViewModel.NameOptionEnum} nameOption
   */
  exports.prototype.nameOption = undefined;

  /**
   * @member {module:model/PermanentEditViewModel.CustomDesOptionEnum} customDesOption
   */
  exports.prototype.customDesOption = undefined;

  /**
   * @member {module:model/PermanentEditViewModel.PermanentTypeEnum} permanentType
   */
