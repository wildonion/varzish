...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.TransactionWithdrawDetailsViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TransactionWithdrawDetailsViewModel model module.
   * @module model/TransactionWithdrawDetailsViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>TransactionWithdrawDetailsViewModel</code>.
   * @alias module:model/TransactionWithdrawDetailsViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionWithdrawDetailsViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionWithdrawDetailsViewModel} obj Optional instance to populate.
   * @return {module:model/TransactionWithdrawDetailsViewModel} The populated <code>TransactionWithdrawDetailsViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isRepaid'))
        obj.isRepaid = ApiClient.convertToType(data['isRepaid'], 'Boolean');
      if (data.hasOwnProperty('repayDate'))
        obj.repayDate = ApiClient.convertToType(data['repayDate'], 'Date');
  ...
  /**
   * @member {Boolean} isRepaid
   */
  exports.prototype.isRepaid = undefined;

  /**
   * @member {Date} repayDate
   */
  exports.prototype.repayDate = undefined;
