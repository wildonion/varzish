...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.PermanentPaymentViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PermanentPaymentViewModel model module.
   * @module model/PermanentPaymentViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PermanentPaymentViewModel</code>.
   * @alias module:model/PermanentPaymentViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PermanentPaymentViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PermanentPaymentViewModel} obj Optional instance to populate.
   * @return {module:model/PermanentPaymentViewModel} The populated <code>PermanentPaymentViewModel</code> instance.
   */
