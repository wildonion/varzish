...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BuyerDetailsViewModel', 'model/PermanentDetailViewModel', 'model/ProductDetailViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BuyerDetailsViewModel'), require('./PermanentDetailViewModel'), require('./ProductDetailViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.PayReportViewModel = factory(root._.ApiClient, root._.BuyerDetailsViewModel, root._.PermanentDetailViewModel, root._.ProductDetailViewModel);
  }
}(this, function(ApiClient, BuyerDetailsViewModel, PermanentDetailViewModel, ProductDetailViewModel) {
  'use strict';

  /**
   * The PayReportViewModel model module.
   * @module model/PayReportViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>PayReportViewModel</code>.
   * @alias module:model/PayReportViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>PayReportViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PayReportViewModel} obj Optional instance to populate.
   * @return {module:model/PayReportViewModel} The populated <code>PayReportViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('product'))
        obj.product = ProductDetailViewModel.constructFromObject(data['product']);
      if (data.hasOwnProperty('permanentLink'))
        obj.permanentLink = PermanentDetailViewModel.constructFromObject(data['permanentLink']);
      if (data.hasOwnProperty('buyer'))
        obj.buyer = BuyerDetailsViewModel.constructFromObject(data['buyer']);
  ...
  /**
   * @member {module:model/ProductDetailViewModel} product
   */
  exports.prototype.product = undefined;

  /**
   * @member {module:model/PermanentDetailViewModel} permanentLink
   */
  exports.prototype.permanentLink = undefined;

  /**
   * @member {module:model/BuyerDetailsViewModel} buyer
   */
