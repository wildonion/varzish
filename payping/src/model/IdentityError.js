...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.IdentityError = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The IdentityError model module.
   * @module model/IdentityError
   * @version v1
   */

  /**
   * Constructs a new <code>IdentityError</code>.
   * @alias module:model/IdentityError
   * @class
   */
  ...
  /**
   * Constructs a <code>IdentityError</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IdentityError} obj Optional instance to populate.
   * @return {module:model/IdentityError} The populated <code>IdentityError</code> instance.
   */
