...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.UpdatePersonalinfoVm = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdatePersonalinfoVm model module.
   * @module model/UpdatePersonalinfoVm
   * @version v1
   */

  /**
   * Constructs a new <code>UpdatePersonalinfoVm</code>.
   * @alias module:model/UpdatePersonalinfoVm
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdatePersonalinfoVm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatePersonalinfoVm} obj Optional instance to populate.
   * @return {module:model/UpdatePersonalinfoVm} The populated <code>UpdatePersonalinfoVm</code> instance.
   */
