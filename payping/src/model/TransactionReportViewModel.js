...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.TransactionReportViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TransactionReportViewModel model module.
   * @module model/TransactionReportViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>TransactionReportViewModel</code>.
   * @alias module:model/TransactionReportViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionReportViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionReportViewModel} obj Optional instance to populate.
   * @return {module:model/TransactionReportViewModel} The populated <code>TransactionReportViewModel</code> instance.
   */
