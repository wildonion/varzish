...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ResultVM = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ResultVM model module.
   * @module model/ResultVM
   * @version v1
   */

  /**
   * Constructs a new <code>ResultVM</code>.
   * @alias module:model/ResultVM
   * @class
   */
  ...
  /**
   * Constructs a <code>ResultVM</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultVM} obj Optional instance to populate.
   * @return {module:model/ResultVM} The populated <code>ResultVM</code> instance.
   */
