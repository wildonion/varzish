...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ProductBuyerViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ProductBuyerViewModel model module.
   * @module model/ProductBuyerViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ProductBuyerViewModel</code>.
   * @alias module:model/ProductBuyerViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>ProductBuyerViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductBuyerViewModel} obj Optional instance to populate.
   * @return {module:model/ProductBuyerViewModel} The populated <code>ProductBuyerViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('customDescription'))
        obj.customDescription = ApiClient.convertToType(data['customDescription'], 'String');
      ...
      if (data.hasOwnProperty('payDateDisplay'))
        obj.payDateDisplay = ApiClient.convertToType(data['payDateDisplay'], 'String');
      if (data.hasOwnProperty('phoneVM'))
        obj.phoneVM = ApiClient.convertToType(data['phoneVM'], 'String');
    }
    return obj;
  }
   ...
   */
  exports.prototype.customDescription = undefined;
  ...
  /**
   * @member {String} payDateDisplay
   */
  exports.prototype.payDateDisplay = undefined;

  /**
   * @member {String} phoneVM
   */
  exports.prototype.phoneVM = undefined;
