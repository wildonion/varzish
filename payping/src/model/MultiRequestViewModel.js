...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.MultiRequestViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MultiRequestViewModel model module.
   * @module model/MultiRequestViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>MultiRequestViewModel</code>.
   * @alias module:model/MultiRequestViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>MultiRequestViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MultiRequestViewModel} obj Optional instance to populate.
   * @return {module:model/MultiRequestViewModel} The populated <code>MultiRequestViewModel</code> instance.
   */
