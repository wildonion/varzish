...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.ProductListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ProductListItemViewModel model module.
   * @module model/ProductListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>ProductListItemViewModel</code>.
   * @alias module:model/ProductListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>ProductListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductListItemViewModel} obj Optional instance to populate.
   * @return {module:model/ProductListItemViewModel} The populated <code>ProductListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amountDisplay'))
        obj.amountDisplay = ApiClient.convertToType(data['amountDisplay'], 'String');
      if (data.hasOwnProperty('quantityVM'))
        obj.quantityVM = ApiClient.convertToType(data['quantityVM'], 'String');
      if (data.hasOwnProperty('isActive'))
        obj.isActive = ApiClient.convertToType(data['isActive'], 'Boolean');
      if (data.hasOwnProperty('haveTax'))
        obj.haveTax = ApiClient.convertToType(data['haveTax'], 'Boolean');
      if (data.hasOwnProperty('havePerma'))
        obj.havePerma = ApiClient.convertToType(data['havePerma'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * @member {String} amountDisplay
   */
  exports.prototype.amountDisplay = undefined;

  /**
   * @member {String} quantityVM
   */
  exports.prototype.quantityVM = undefined;
  ...
  /**
   * @member {Boolean} havePerma
   */
  exports.prototype.havePerma = undefined;
