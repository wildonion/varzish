...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.SocialUserInfoExtraViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SocialUserInfoExtraViewModel model module.
   * @module model/SocialUserInfoExtraViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>SocialUserInfoExtraViewModel</code>.
   * @alias module:model/SocialUserInfoExtraViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>SocialUserInfoExtraViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SocialUserInfoExtraViewModel} obj Optional instance to populate.
   * @return {module:model/SocialUserInfoExtraViewModel} The populated <code>SocialUserInfoExtraViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('allSocialIsNull'))
        obj.allSocialIsNull = ApiClient.convertToType(data['allSocialIsNull'], 'Boolean');
    }
    return obj;
  }
   ...
   */
  exports.prototype.telegram = undefined;
  ...
  /**
   * @member {Boolean} allSocialIsNull
   */
  exports.prototype.allSocialIsNull = undefined;
