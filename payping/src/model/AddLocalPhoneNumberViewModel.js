...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddLocalPhoneNumberViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddLocalPhoneNumberViewModel model module.
   * @module model/AddLocalPhoneNumberViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>AddLocalPhoneNumberViewModel</code>.
   * @alias module:model/AddLocalPhoneNumberViewModel
   * @class
   * @param localPhone {String} 
   */
  var exports = function(localPhone) {
    this.localPhone = localPhone;
  };

  /**
   * Constructs a <code>AddLocalPhoneNumberViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddLocalPhoneNumberViewModel} obj Optional instance to populate.
   * @return {module:model/AddLocalPhoneNumberViewModel} The populated <code>AddLocalPhoneNumberViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('localPhone'))
        obj.localPhone = ApiClient.convertToType(data['localPhone'], 'String');
    }
    return obj;
  }

  /**
   * @member {String} localPhone
   */
  exports.prototype.localPhone = undefined;
