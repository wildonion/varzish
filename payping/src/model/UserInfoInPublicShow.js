...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SocialUserInfoExtraViewModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SocialUserInfoExtraViewModel'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.UserInfoInPublicShow = factory(root._.ApiClient, root._.SocialUserInfoExtraViewModel);
  }
}(this, function(ApiClient, SocialUserInfoExtraViewModel) {
  'use strict';

  /**
   * The UserInfoInPublicShow model module.
   * @module model/UserInfoInPublicShow
   * @version v1
   */

  /**
   * Constructs a new <code>UserInfoInPublicShow</code>.
   * @alias module:model/UserInfoInPublicShow
   * @class
   */
  ...
  /**
   * Constructs a <code>UserInfoInPublicShow</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserInfoInPublicShow} obj Optional instance to populate.
   * @return {module:model/UserInfoInPublicShow} The populated <code>UserInfoInPublicShow</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('verifyType'))
        obj.verifyType = ApiClient.convertToType(data['verifyType'], 'Number');
      if (data.hasOwnProperty('socials'))
        obj.socials = SocialUserInfoExtraViewModel.constructFromObject(data['socials']);
    }
    return obj;
  }
  ...
  /**
   * @member {Number} verifyType
   */
  exports.prototype.verifyType = undefined;

  /**
   * @member {module:model/SocialUserInfoExtraViewModel} socials
   */
