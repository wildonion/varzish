...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.AddPhoneNumberViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddPhoneNumberViewModel model module.
   * @module model/AddPhoneNumberViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>AddPhoneNumberViewModel</code>.
   * @alias module:model/AddPhoneNumberViewModel
   * @class
  ...
  /**
   * Constructs a <code>AddPhoneNumberViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddPhoneNumberViewModel} obj Optional instance to populate.
   * @return {module:model/AddPhoneNumberViewModel} The populated <code>AddPhoneNumberViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isVerifyed'))
        obj.isVerifyed = ApiClient.convertToType(data['isVerifyed'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * @member {Boolean} isVerifyed
   */
  exports.prototype.isVerifyed = undefined;
