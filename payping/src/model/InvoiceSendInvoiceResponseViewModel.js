...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceSendInvoiceResponseViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceSendInvoiceResponseViewModel model module.
   * @module model/InvoiceSendInvoiceResponseViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceSendInvoiceResponseViewModel</code>.
   * بازگشت مشخصات درخواست ارسال فاکتور
   * @alias module:model/InvoiceSendInvoiceResponseViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceSendInvoiceResponseViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceSendInvoiceResponseViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceSendInvoiceResponseViewModel} The populated <code>InvoiceSendInvoiceResponseViewModel</code> instance.
   */
