...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CodeVM = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CodeVM model module.
   * @module model/CodeVM
   * @version v1
   */

  /**
   * Constructs a new <code>CodeVM</code>.
   * @alias module:model/CodeVM
   * @class
   */
  ...
  /**
   * Constructs a <code>CodeVM</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CodeVM} obj Optional instance to populate.
   * @return {module:model/CodeVM} The populated <code>CodeVM</code> instance.
   */
