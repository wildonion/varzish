...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.InvoiceCcToCreateOrUpdateViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InvoiceCcToCreateOrUpdateViewModel model module.
   * @module model/InvoiceCcToCreateOrUpdateViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>InvoiceCcToCreateOrUpdateViewModel</code>.
   * CC
   * @alias module:model/InvoiceCcToCreateOrUpdateViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>InvoiceCcToCreateOrUpdateViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InvoiceCcToCreateOrUpdateViewModel} obj Optional instance to populate.
   * @return {module:model/InvoiceCcToCreateOrUpdateViewModel} The populated <code>InvoiceCcToCreateOrUpdateViewModel</code> instance.
   */
   ...
   * @default ''
   */
  exports.prototype.emailAddress = '';
