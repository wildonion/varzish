...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CouponListItemViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CouponListItemViewModel model module.
   * @module model/CouponListItemViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CouponListItemViewModel</code>.
   * @alias module:model/CouponListItemViewModel
   * @class
   */
  ...
  /**
   * Constructs a <code>CouponListItemViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponListItemViewModel} obj Optional instance to populate.
   * @return {module:model/CouponListItemViewModel} The populated <code>CouponListItemViewModel</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('activeProductName'))
        obj.activeProductName = ApiClient.convertToType(data['activeProductName'], ['String']);
  ...
  /**
   * @member {module:model/CouponListItemViewModel.TypeEnum} type
   */
  ...
  /**
   * @member {Array.<String>} activeProductName
   */
  exports.prototype.activeProductName = undefined;
