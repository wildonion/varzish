...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.BaseIntegration = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BaseIntegration model module.
   * @module model/BaseIntegration
   * @version v1
   */

  /**
   * Constructs a new <code>BaseIntegration</code>.
   * @alias module:model/BaseIntegration
   * @class
   */
  ...
  /**
   * Constructs a <code>BaseIntegration</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BaseIntegration} obj Optional instance to populate.
   * @return {module:model/BaseIntegration} The populated <code>BaseIntegration</code> instance.
   */
  ...
  /**
   * @member {module:model/BaseIntegration.ServiceTypeEnum} serviceType
   */
