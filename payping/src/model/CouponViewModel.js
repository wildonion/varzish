...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root._.CouponViewModel = factory(root._.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CouponViewModel model module.
   * @module model/CouponViewModel
   * @version v1
   */

  /**
   * Constructs a new <code>CouponViewModel</code>.
   * @alias module:model/CouponViewModel
   * @class
   * @param couponCode {String} 
   */
  var exports = function(couponCode) {
    this.couponCode = couponCode;
  };

  /**
   * Constructs a <code>CouponViewModel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CouponViewModel} obj Optional instance to populate.
   * @return {module:model/CouponViewModel} The populated <code>CouponViewModel</code> instance.
   */
