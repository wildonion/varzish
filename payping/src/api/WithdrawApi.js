...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/WithdrawDetailsViewModel', 'model/WithdrawResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/WithdrawDetailsViewModel'), require('../model/WithdrawResult'));
  } else {
    // Browser globals (root is window)
    if (!root._) {
      root._ = {};
    }
    root._.WithdrawApi = factory(root._.ApiClient, root._.WithdrawDetailsViewModel, root._.WithdrawResult);
  }
}(this, function(ApiClient, WithdrawDetailsViewModel, WithdrawResult) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/WithdrawResult} data The data returned by the service call.
     ...
     * @param {Number} amount مبلغ تسویه حساب
     ...
     * data is of type: {@link module:model/WithdrawResult}
     */
    this.withdrawCreate = function(amount, callback) {
      var postBody = null;

      // verify the required parameter 'amount' is set
      if (amount === undefined || amount === null) {
        throw new Error("Missing the required parameter 'amount' when calling withdrawCreate");
      }
      ...
      var returnType = WithdrawResult;

      return this.apiClient.callApi(
        '/v1/withdraw/{amount}', 'POST',
    ...
    /**
     * Callback function to receive the result of the withdrawDetails operation.
     * @callback module:api/WithdrawApi~withdrawDetailsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/WithdrawDetailsViewModel} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} code کد درخواست تسویه
     * @param {module:api/WithdrawApi~withdrawDetailsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/WithdrawDetailsViewModel}
     */
    this.withdrawDetails = function(code, callback) {
      var postBody = null;

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling withdrawDetails");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = WithdrawDetailsViewModel;

      return this.apiClient.callApi(
        '/v1/withdrawdetails/{code}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
