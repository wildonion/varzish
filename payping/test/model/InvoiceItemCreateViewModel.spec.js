...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceItemCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceItemCreateViewModel();
      });

      it('should create an instance of InvoiceItemCreateViewModel', function() {
        // TODO: update the code to test InvoiceItemCreateViewModel
        expect(instance).to.be.a(_.InvoiceItemCreateViewModel);
      });
