...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionReportViewModel', function() {
      beforeEach(function() {
        instance = new _.TransactionReportViewModel();
      });

      it('should create an instance of TransactionReportViewModel', function() {
        // TODO: update the code to test TransactionReportViewModel
        expect(instance).to.be.a(_.TransactionReportViewModel);
      });
