...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddLocalPhoneNumberViewModel', function() {
      beforeEach(function() {
        instance = new _.AddLocalPhoneNumberViewModel();
      });

      it('should create an instance of AddLocalPhoneNumberViewModel', function() {
        // TODO: update the code to test AddLocalPhoneNumberViewModel
        expect(instance).to.be.a(_.AddLocalPhoneNumberViewModel);
      });
