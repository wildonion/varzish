...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListCountViewModel', function() {
      beforeEach(function() {
        instance = new _.ListCountViewModel();
      });

      it('should create an instance of ListCountViewModel', function() {
        // TODO: update the code to test ListCountViewModel
        expect(instance).to.be.a(_.ListCountViewModel);
      });
