...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdatePersonalinfoVm', function() {
      beforeEach(function() {
        instance = new _.UpdatePersonalinfoVm();
      });

      it('should create an instance of UpdatePersonalinfoVm', function() {
        // TODO: update the code to test UpdatePersonalinfoVm
        expect(instance).to.be.a(_.UpdatePersonalinfoVm);
      });
