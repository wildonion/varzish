...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductListItemViewModel();
      });

      it('should create an instance of ProductListItemViewModel', function() {
        // TODO: update the code to test ProductListItemViewModel
        expect(instance).to.be.a(_.ProductListItemViewModel);
      });
      ...
      it('should have the property amountDisplay (base name: "amountDisplay")', function() {
        // TODO: update the code to test the property amountDisplay
        expect(instance).to.have.property('amountDisplay');
        // expect(instance.amountDisplay).to.be(expectedValueLiteral);
      });

      it('should have the property quantityVM (base name: "quantityVM")', function() {
        // TODO: update the code to test the property quantityVM
        expect(instance).to.have.property('quantityVM');
        // expect(instance.quantityVM).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property haveTax (base name: "haveTax")', function() {
        // TODO: update the code to test the property haveTax
        expect(instance).to.have.property('haveTax');
        // expect(instance.haveTax).to.be(expectedValueLiteral);
      });

      it('should have the property havePerma (base name: "havePerma")', function() {
        // TODO: update the code to test the property havePerma
        expect(instance).to.have.property('havePerma');
        // expect(instance.havePerma).to.be(expectedValueLiteral);
      });
