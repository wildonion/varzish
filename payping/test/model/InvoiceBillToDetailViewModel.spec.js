...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceBillToDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceBillToDetailViewModel();
      });

      it('should create an instance of InvoiceBillToDetailViewModel', function() {
        // TODO: update the code to test InvoiceBillToDetailViewModel
        expect(instance).to.be.a(_.InvoiceBillToDetailViewModel);
      });
