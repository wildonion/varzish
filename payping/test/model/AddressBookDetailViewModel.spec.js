...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressBookDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.AddressBookDetailViewModel();
      });

      it('should create an instance of AddressBookDetailViewModel', function() {
        // TODO: update the code to test AddressBookDetailViewModel
        expect(instance).to.be.a(_.AddressBookDetailViewModel);
      });
      ...
      it('should have the property userPhotoFileAddress (base name: "userPhotoFileAddress")', function() {
        // TODO: update the code to test the property userPhotoFileAddress
        expect(instance).to.have.property('userPhotoFileAddress');
        // expect(instance.userPhotoFileAddress).to.be(expectedValueLiteral);
      });

      it('should have the property userPhotoFileId (base name: "userPhotoFileId")', function() {
        // TODO: update the code to test the property userPhotoFileId
        expect(instance).to.have.property('userPhotoFileId');
        // expect(instance.userPhotoFileId).to.be(expectedValueLiteral);
      });
