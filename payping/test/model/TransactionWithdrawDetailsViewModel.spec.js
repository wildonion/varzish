...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionWithdrawDetailsViewModel', function() {
      beforeEach(function() {
        instance = new _.TransactionWithdrawDetailsViewModel();
      });

      it('should create an instance of TransactionWithdrawDetailsViewModel', function() {
        // TODO: update the code to test TransactionWithdrawDetailsViewModel
        expect(instance).to.be.a(_.TransactionWithdrawDetailsViewModel);
      });
      ...
      it('should have the property isRepaid (base name: "isRepaid")', function() {
        // TODO: update the code to test the property isRepaid
        expect(instance).to.have.property('isRepaid');
        // expect(instance.isRepaid).to.be(expectedValueLiteral);
      });

      it('should have the property repayDate (base name: "repayDate")', function() {
        // TODO: update the code to test the property repayDate
        expect(instance).to.have.property('repayDate');
        // expect(instance.repayDate).to.be(expectedValueLiteral);
      });
