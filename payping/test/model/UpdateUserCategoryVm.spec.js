...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateUserCategoryVm', function() {
      beforeEach(function() {
        instance = new _.UpdateUserCategoryVm();
      });

      it('should create an instance of UpdateUserCategoryVm', function() {
        // TODO: update the code to test UpdateUserCategoryVm
        expect(instance).to.be.a(_.UpdateUserCategoryVm);
      });
      ...
      it('should have the property subCategoryId (base name: "subCategoryId")', function() {
