...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSendByTemplateSimple', function() {
      beforeEach(function() {
        instance = new _.InvoiceSendByTemplateSimple();
      });

      it('should create an instance of InvoiceSendByTemplateSimple', function() {
        // TODO: update the code to test InvoiceSendByTemplateSimple
        expect(instance).to.be.a(_.InvoiceSendByTemplateSimple);
      });
