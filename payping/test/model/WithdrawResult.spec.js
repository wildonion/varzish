...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WithdrawResult', function() {
      beforeEach(function() {
        instance = new _.WithdrawResult();
      });

      it('should create an instance of WithdrawResult', function() {
        // TODO: update the code to test WithdrawResult
        expect(instance).to.be.a(_.WithdrawResult);
      });
