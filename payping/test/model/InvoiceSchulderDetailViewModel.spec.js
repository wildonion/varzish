...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSchulderDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceSchulderDetailViewModel();
      });

      it('should create an instance of InvoiceSchulderDetailViewModel', function() {
        // TODO: update the code to test InvoiceSchulderDetailViewModel
        expect(instance).to.be.a(_.InvoiceSchulderDetailViewModel);
      });

      it('should have the property repeat (base name: "repeat")', function() {
        // TODO: update the code to test the property repeat
        expect(instance).to.have.property('repeat');
        // expect(instance.repeat).to.be(expectedValueLiteral);
      });

      it('should have the property schulderType (base name: "schulderType")', function() {
        // TODO: update the code to test the property schulderType
        expect(instance).to.have.property('schulderType');
        // expect(instance.schulderType).to.be(expectedValueLiteral);
      });

      it('should have the property dueType (base name: "dueType")', function() {
        // TODO: update the code to test the property dueType
        expect(instance).to.have.property('dueType');
        // expect(instance.dueType).to.be(expectedValueLiteral);
      });

      it('should have the property endValue (base name: "endValue")', function() {
        // TODO: update the code to test the property endValue
        expect(instance).to.have.property('endValue');
        // expect(instance.endValue).to.be(expectedValueLiteral);
      });

      it('should have the property dueDateAfterHowManyDay (base name: "dueDateAfterHowManyDay")', function() {
        // TODO: update the code to test the property dueDateAfterHowManyDay
        expect(instance).to.have.property('dueDateAfterHowManyDay');
        // expect(instance.dueDateAfterHowManyDay).to.be(expectedValueLiteral);
      });

      it('should have the property invoiceSubSchulders (base name: "invoiceSubSchulders")', function() {
        // TODO: update the code to test the property invoiceSubSchulders
        expect(instance).to.have.property('invoiceSubSchulders');
        // expect(instance.invoiceSubSchulders).to.be(expectedValueLiteral);
      });
