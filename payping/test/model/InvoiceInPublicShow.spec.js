...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceInPublicShow', function() {
      beforeEach(function() {
        instance = new _.InvoiceInPublicShow();
      });

      it('should create an instance of InvoiceInPublicShow', function() {
        // TODO: update the code to test InvoiceInPublicShow
        expect(instance).to.be.a(_.InvoiceInPublicShow);
      });
      ...
      it('should have the property ownerInfo (base name: "ownerInfo")', function() {
        // TODO: update the code to test the property ownerInfo
        expect(instance).to.have.property('ownerInfo');
        // expect(instance.ownerInfo).to.be(expectedValueLiteral);
      });
