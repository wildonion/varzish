...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateItemIndexViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateItemIndexViewModel();
      });

      it('should create an instance of InvoiceTemplateItemIndexViewModel', function() {
        // TODO: update the code to test InvoiceTemplateItemIndexViewModel
        expect(instance).to.be.a(_.InvoiceTemplateItemIndexViewModel);
      });
