...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MultiPayPair', function() {
      beforeEach(function() {
        instance = new _.MultiPayPair();
      });

      it('should create an instance of MultiPayPair', function() {
        // TODO: update the code to test MultiPayPair
        expect(instance).to.be.a(_.MultiPayPair);
      });
