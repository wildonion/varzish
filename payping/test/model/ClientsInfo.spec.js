...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClientsInfo', function() {
      beforeEach(function() {
        instance = new _.ClientsInfo();
      });

      it('should create an instance of ClientsInfo', function() {
        // TODO: update the code to test ClientsInfo
        expect(instance).to.be.a(_.ClientsInfo);
      });
