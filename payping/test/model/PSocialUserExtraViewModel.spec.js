...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PSocialUserExtraViewModel', function() {
      beforeEach(function() {
        instance = new _.PSocialUserExtraViewModel();
      });

      it('should create an instance of PSocialUserExtraViewModel', function() {
        // TODO: update the code to test PSocialUserExtraViewModel
        expect(instance).to.be.a(_.PSocialUserExtraViewModel);
      });
