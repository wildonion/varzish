...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EditLocalInfoesViewModel', function() {
      beforeEach(function() {
        instance = new _.EditLocalInfoesViewModel();
      });

      it('should create an instance of EditLocalInfoesViewModel', function() {
        // TODO: update the code to test EditLocalInfoesViewModel
        expect(instance).to.be.a(_.EditLocalInfoesViewModel);
      });
