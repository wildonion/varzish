...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreatePaymentViewModel', function() {
      beforeEach(function() {
        instance = new _.CreatePaymentViewModel();
      });

      it('should create an instance of CreatePaymentViewModel', function() {
        // TODO: update the code to test CreatePaymentViewModel
        expect(instance).to.be.a(_.CreatePaymentViewModel);
      });
