...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoicePdfResponseViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoicePdfResponseViewModel();
      });

      it('should create an instance of InvoicePdfResponseViewModel', function() {
        // TODO: update the code to test InvoicePdfResponseViewModel
        expect(instance).to.be.a(_.InvoicePdfResponseViewModel);
      });
      ...
      it('should have the property fileAddress (base name: "fileAddress")', function() {
        // TODO: update the code to test the property fileAddress
        expect(instance).to.have.property('fileAddress');
        // expect(instance.fileAddress).to.be(expectedValueLiteral);
      });
