...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductFullDeatilViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductFullDeatilViewModel();
      });

      it('should create an instance of ProductFullDeatilViewModel', function() {
        // TODO: update the code to test ProductFullDeatilViewModel
        expect(instance).to.be.a(_.ProductFullDeatilViewModel);
      });
      ...
      it('should have the property imageLink (base name: "imageLink")', function() {
        // TODO: update the code to test the property imageLink
        expect(instance).to.have.property('imageLink');
        // expect(instance.imageLink).to.be(expectedValueLiteral);
      });
