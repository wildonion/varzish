...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSchulderCreateOrUpdateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceSchulderCreateOrUpdateViewModel();
      });

      it('should create an instance of InvoiceSchulderCreateOrUpdateViewModel', function() {
        // TODO: update the code to test InvoiceSchulderCreateOrUpdateViewModel
        expect(instance).to.be.a(_.InvoiceSchulderCreateOrUpdateViewModel);
      });
