...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateRequestViewModel', function() {
      beforeEach(function() {
        instance = new _.CreateRequestViewModel();
      });

      it('should create an instance of CreateRequestViewModel', function() {
        // TODO: update the code to test CreateRequestViewModel
        expect(instance).to.be.a(_.CreateRequestViewModel);
      });
