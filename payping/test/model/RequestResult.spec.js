...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RequestResult', function() {
      beforeEach(function() {
        instance = new _.RequestResult();
      });

      it('should create an instance of RequestResult', function() {
        // TODO: update the code to test RequestResult
        expect(instance).to.be.a(_.RequestResult);
      });
