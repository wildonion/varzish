...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankViewModel', function() {
      beforeEach(function() {
        instance = new _.BankViewModel();
      });

      it('should create an instance of BankViewModel', function() {
        // TODO: update the code to test BankViewModel
        expect(instance).to.be.a(_.BankViewModel);
      });
      ...
      it('should have the property shabaVerifyed (base name: "shabaVerifyed")', function() {
        // TODO: update the code to test the property shabaVerifyed
        expect(instance).to.have.property('shabaVerifyed');
        // expect(instance.shabaVerifyed).to.be(expectedValueLiteral);
      });
