...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PermanentListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.PermanentListItemViewModel();
      });

      it('should create an instance of PermanentListItemViewModel', function() {
        // TODO: update the code to test PermanentListItemViewModel
        expect(instance).to.be.a(_.PermanentListItemViewModel);
      });
      ...
      it('should have the property defineAmountByUser (base name: "defineAmountByUser")', function() {
        // TODO: update the code to test the property defineAmountByUser
        expect(instance).to.have.property('defineAmountByUser');
        // expect(instance.defineAmountByUser).to.be(expectedValueLiteral);
      });

      it('should have the property itemIsActive (base name: "itemIsActive")', function() {
        // TODO: update the code to test the property itemIsActive
        expect(instance).to.have.property('itemIsActive');
        // expect(instance.itemIsActive).to.be(expectedValueLiteral);
      });

      it('should have the property itemIsAvailable (base name: "itemIsAvailable")', function() {
        // TODO: update the code to test the property itemIsAvailable
        expect(instance).to.have.property('itemIsAvailable');
        // expect(instance.itemIsAvailable).to.be(expectedValueLiteral);
      });
