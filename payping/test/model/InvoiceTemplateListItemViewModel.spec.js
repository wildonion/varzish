...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateListItemViewModel();
      });

      it('should create an instance of InvoiceTemplateListItemViewModel', function() {
        // TODO: update the code to test InvoiceTemplateListItemViewModel
        expect(instance).to.be.a(_.InvoiceTemplateListItemViewModel);
      });
      ...
      it('should have the property hasSchulder (base name: "hasSchulder")', function() {
        // TODO: update the code to test the property hasSchulder
        expect(instance).to.have.property('hasSchulder');
        // expect(instance.hasSchulder).to.be(expectedValueLiteral);
      });
