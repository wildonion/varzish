...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.CouponDetailViewModel();
      });

      it('should create an instance of CouponDetailViewModel', function() {
        // TODO: update the code to test CouponDetailViewModel
        expect(instance).to.be.a(_.CouponDetailViewModel);
      });
