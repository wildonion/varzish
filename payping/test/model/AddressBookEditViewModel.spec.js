...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressBookEditViewModel', function() {
      beforeEach(function() {
        instance = new _.AddressBookEditViewModel();
      });

      it('should create an instance of AddressBookEditViewModel', function() {
        // TODO: update the code to test AddressBookEditViewModel
        expect(instance).to.be.a(_.AddressBookEditViewModel);
      });
