...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ResultVM', function() {
      beforeEach(function() {
        instance = new _.ResultVM();
      });

      it('should create an instance of ResultVM', function() {
        // TODO: update the code to test ResultVM
        expect(instance).to.be.a(_.ResultVM);
      });
