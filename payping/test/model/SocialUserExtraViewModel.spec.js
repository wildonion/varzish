...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SocialUserExtraViewModel', function() {
      beforeEach(function() {
        instance = new _.SocialUserExtraViewModel();
      });

      it('should create an instance of SocialUserExtraViewModel', function() {
        // TODO: update the code to test SocialUserExtraViewModel
        expect(instance).to.be.a(_.SocialUserExtraViewModel);
      });
      ...
      it('should have the property telegram (base name: "telegram")', function() {
        // TODO: update the code to test the property telegram
        expect(instance).to.have.property('telegram');
        // expect(instance.telegram).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property allSocialIsNull (base name: "allSocialIsNull")', function() {
        // TODO: update the code to test the property allSocialIsNull
        expect(instance).to.have.property('allSocialIsNull');
        // expect(instance.allSocialIsNull).to.be(expectedValueLiteral);
      });
