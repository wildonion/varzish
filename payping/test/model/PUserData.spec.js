...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PUserData', function() {
      beforeEach(function() {
        instance = new _.PUserData();
      });

      it('should create an instance of PUserData', function() {
        // TODO: update the code to test PUserData
        expect(instance).to.be.a(_.PUserData);
      });
      ...
      it('should have the property isBusiness (base name: "isBusiness")', function() {
      ...
      it('should have the property verifyType (base name: "verifyType")', function() {
        // TODO: update the code to test the property verifyType
        expect(instance).to.have.property('verifyType');
        // expect(instance.verifyType).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property customFrontPay (base name: "customFrontPay")', function() {
        // TODO: update the code to test the property customFrontPay
        expect(instance).to.have.property('customFrontPay');
        // expect(instance.customFrontPay).to.be(expectedValueLiteral);
      });

      it('should have the property maxPaymntAmount (base name: "maxPaymntAmount")', function() {
        // TODO: update the code to test the property maxPaymntAmount
        expect(instance).to.have.property('maxPaymntAmount');
        // expect(instance.maxPaymntAmount).to.be(expectedValueLiteral);
      });
