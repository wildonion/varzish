...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PermanentPaymentViewModel', function() {
      beforeEach(function() {
        instance = new _.PermanentPaymentViewModel();
      });

      it('should create an instance of PermanentPaymentViewModel', function() {
        // TODO: update the code to test PermanentPaymentViewModel
        expect(instance).to.be.a(_.PermanentPaymentViewModel);
      });
