...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateSchulderCreateOrUpdateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateSchulderCreateOrUpdateViewModel();
      });

      it('should create an instance of InvoiceTemplateSchulderCreateOrUpdateViewModel', function() {
        // TODO: update the code to test InvoiceTemplateSchulderCreateOrUpdateViewModel
        expect(instance).to.be.a(_.InvoiceTemplateSchulderCreateOrUpdateViewModel);
      });
