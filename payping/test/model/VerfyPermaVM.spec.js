...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerfyPermaVM', function() {
      beforeEach(function() {
        instance = new _.VerfyPermaVM();
      });

      it('should create an instance of VerfyPermaVM', function() {
        // TODO: update the code to test VerfyPermaVM
        expect(instance).to.be.a(_.VerfyPermaVM);
      });

      it('should have the property payCode (base name: "payCode")', function() {
        // TODO: update the code to test the property payCode
        expect(instance).to.have.property('payCode');
        // expect(instance.payCode).to.be(expectedValueLiteral);
      });
