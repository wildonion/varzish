...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateItemCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateItemCreateViewModel();
      });

      it('should create an instance of InvoiceTemplateItemCreateViewModel', function() {
        // TODO: update the code to test InvoiceTemplateItemCreateViewModel
        expect(instance).to.be.a(_.InvoiceTemplateItemCreateViewModel);
      });
      ...
      it('should have the property discountCouponCode (base name: "discountCouponCode")', function() {
        // TODO: update the code to test the property discountCouponCode
        expect(instance).to.have.property('discountCouponCode');
        // expect(instance.discountCouponCode).to.be(expectedValueLiteral);
      });
