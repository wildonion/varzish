...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceBillToListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceBillToListItemViewModel();
      });

      it('should create an instance of InvoiceBillToListItemViewModel', function() {
        // TODO: update the code to test InvoiceBillToListItemViewModel
        expect(instance).to.be.a(_.InvoiceBillToListItemViewModel);
      });

      it('should have the property addressBook (base name: "addressBook")', function() {
        // TODO: update the code to test the property addressBook
        expect(instance).to.have.property('addressBook');
        // expect(instance.addressBook).to.be(expectedValueLiteral);
      });
