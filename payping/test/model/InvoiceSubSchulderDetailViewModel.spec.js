...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSubSchulderDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceSubSchulderDetailViewModel();
      });

      it('should create an instance of InvoiceSubSchulderDetailViewModel', function() {
        // TODO: update the code to test InvoiceSubSchulderDetailViewModel
        expect(instance).to.be.a(_.InvoiceSubSchulderDetailViewModel);
      });
      ...
      it('should have the property mustBeCreateInDateTime (base name: "mustBeCreateInDateTime")', function() {
        // TODO: update the code to test the property mustBeCreateInDateTime
        expect(instance).to.have.property('mustBeCreateInDateTime');
        // expect(instance.mustBeCreateInDateTime).to.be(expectedValueLiteral);
      });

      it('should have the property deActiveDateTime (base name: "deActiveDateTime")', function() {
        // TODO: update the code to test the property deActiveDateTime
        expect(instance).to.have.property('deActiveDateTime');
        // expect(instance.deActiveDateTime).to.be(expectedValueLiteral);
      });

      it('should have the property isInvoiceCreated (base name: "isInvoiceCreated")', function() {
        // TODO: update the code to test the property isInvoiceCreated
        expect(instance).to.have.property('isInvoiceCreated');
        // expect(instance.isInvoiceCreated).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property invoiceCode (base name: "invoiceCode")', function() {
        // TODO: update the code to test the property invoiceCode
        expect(instance).to.have.property('invoiceCode');
        // expect(instance.invoiceCode).to.be(expectedValueLiteral);
      });
