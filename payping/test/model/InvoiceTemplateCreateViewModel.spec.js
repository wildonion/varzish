...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateCreateViewModel();
      });

      it('should create an instance of InvoiceTemplateCreateViewModel', function() {
        // TODO: update the code to test InvoiceTemplateCreateViewModel
        expect(instance).to.be.a(_.InvoiceTemplateCreateViewModel);
      });
