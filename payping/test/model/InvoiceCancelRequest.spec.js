...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceCancelRequest', function() {
      beforeEach(function() {
        instance = new _.InvoiceCancelRequest();
      });

      it('should create an instance of InvoiceCancelRequest', function() {
        // TODO: update the code to test InvoiceCancelRequest
        expect(instance).to.be.a(_.InvoiceCancelRequest);
      });
