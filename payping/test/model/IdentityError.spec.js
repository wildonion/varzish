...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdentityError', function() {
      beforeEach(function() {
        instance = new _.IdentityError();
      });

      it('should create an instance of IdentityError', function() {
        // TODO: update the code to test IdentityError
        expect(instance).to.be.a(_.IdentityError);
      });
