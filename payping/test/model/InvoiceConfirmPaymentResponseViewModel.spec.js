...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceConfirmPaymentResponseViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceConfirmPaymentResponseViewModel();
      });

      it('should create an instance of InvoiceConfirmPaymentResponseViewModel', function() {
        // TODO: update the code to test InvoiceConfirmPaymentResponseViewModel
        expect(instance).to.be.a(_.InvoiceConfirmPaymentResponseViewModel);
      });
      ...
      it('should have the property previewKey (base name: "previewKey")', function() {
        // TODO: update the code to test the property previewKey
        expect(instance).to.have.property('previewKey');
        // expect(instance.previewKey).to.be(expectedValueLiteral);
      });
