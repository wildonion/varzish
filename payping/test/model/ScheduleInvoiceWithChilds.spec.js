...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ScheduleInvoiceWithChilds', function() {
      beforeEach(function() {
        instance = new _.ScheduleInvoiceWithChilds();
      });

      it('should create an instance of ScheduleInvoiceWithChilds', function() {
        // TODO: update the code to test ScheduleInvoiceWithChilds
        expect(instance).to.be.a(_.ScheduleInvoiceWithChilds);
      });

      it('should have the property parentInvoice (base name: "parentInvoice")', function() {
        // TODO: update the code to test the property parentInvoice
        expect(instance).to.have.property('parentInvoice');
        // expect(instance.parentInvoice).to.be(expectedValueLiteral);
      });

      it('should have the property childInvoices (base name: "childInvoices")', function() {
        // TODO: update the code to test the property childInvoices
        expect(instance).to.have.property('childInvoices');
        // expect(instance.childInvoices).to.be(expectedValueLiteral);
      });
