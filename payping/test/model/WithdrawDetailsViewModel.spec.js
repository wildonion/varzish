...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WithdrawDetailsViewModel', function() {
      beforeEach(function() {
        instance = new _.WithdrawDetailsViewModel();
      });

      it('should create an instance of WithdrawDetailsViewModel', function() {
        // TODO: update the code to test WithdrawDetailsViewModel
        expect(instance).to.be.a(_.WithdrawDetailsViewModel);
      });
