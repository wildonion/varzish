...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.CouponListItemViewModel();
      });

      it('should create an instance of CouponListItemViewModel', function() {
        // TODO: update the code to test CouponListItemViewModel
        expect(instance).to.be.a(_.CouponListItemViewModel);
      });
      ...
      it('should have the property activeProductName (base name: "activeProductName")', function() {
        // TODO: update the code to test the property activeProductName
        expect(instance).to.have.property('activeProductName');
        // expect(instance.activeProductName).to.be(expectedValueLiteral);
      });
