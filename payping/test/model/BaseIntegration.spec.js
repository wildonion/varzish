...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseIntegration', function() {
      beforeEach(function() {
        instance = new _.BaseIntegration();
      });

      it('should create an instance of BaseIntegration', function() {
        // TODO: update the code to test BaseIntegration
        expect(instance).to.be.a(_.BaseIntegration);
      });
