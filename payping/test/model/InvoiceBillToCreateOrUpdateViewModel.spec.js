...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceBillToCreateOrUpdateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceBillToCreateOrUpdateViewModel();
      });

      it('should create an instance of InvoiceBillToCreateOrUpdateViewModel', function() {
        // TODO: update the code to test InvoiceBillToCreateOrUpdateViewModel
        expect(instance).to.be.a(_.InvoiceBillToCreateOrUpdateViewModel);
      });

      it('should have the property addressBookCode (base name: "addressBookCode")', function() {
        // TODO: update the code to test the property addressBookCode
        expect(instance).to.have.property('addressBookCode');
        // expect(instance.addressBookCode).to.be(expectedValueLiteral);
      });
