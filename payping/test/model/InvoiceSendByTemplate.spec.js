...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSendByTemplate', function() {
      beforeEach(function() {
        instance = new _.InvoiceSendByTemplate();
      });

      it('should create an instance of InvoiceSendByTemplate', function() {
        // TODO: update the code to test InvoiceSendByTemplate
        expect(instance).to.be.a(_.InvoiceSendByTemplate);
      });
