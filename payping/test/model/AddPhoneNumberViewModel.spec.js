...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddPhoneNumberViewModel', function() {
      beforeEach(function() {
        instance = new _.AddPhoneNumberViewModel();
      });

      it('should create an instance of AddPhoneNumberViewModel', function() {
        // TODO: update the code to test AddPhoneNumberViewModel
        expect(instance).to.be.a(_.AddPhoneNumberViewModel);
      });
      ...
      it('should have the property isVerifyed (base name: "isVerifyed")', function() {
        // TODO: update the code to test the property isVerifyed
        expect(instance).to.have.property('isVerifyed');
        // expect(instance.isVerifyed).to.be(expectedValueLiteral);
      });
