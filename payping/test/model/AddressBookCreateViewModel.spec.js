...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressBookCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.AddressBookCreateViewModel();
      });

      it('should create an instance of AddressBookCreateViewModel', function() {
        // TODO: update the code to test AddressBookCreateViewModel
        expect(instance).to.be.a(_.AddressBookCreateViewModel);
      });
