...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MultiRequestViewModel', function() {
      beforeEach(function() {
        instance = new _.MultiRequestViewModel();
      });

      it('should create an instance of MultiRequestViewModel', function() {
        // TODO: update the code to test MultiRequestViewModel
        expect(instance).to.be.a(_.MultiRequestViewModel);
      });
