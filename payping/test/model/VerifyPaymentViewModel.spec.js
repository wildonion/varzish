...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VerifyPaymentViewModel', function() {
      beforeEach(function() {
        instance = new _.VerifyPaymentViewModel();
      });

      it('should create an instance of VerifyPaymentViewModel', function() {
        // TODO: update the code to test VerifyPaymentViewModel
        expect(instance).to.be.a(_.VerifyPaymentViewModel);
      });
