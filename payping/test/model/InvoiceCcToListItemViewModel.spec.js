...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceCcToListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceCcToListItemViewModel();
      });

      it('should create an instance of InvoiceCcToListItemViewModel', function() {
        // TODO: update the code to test InvoiceCcToListItemViewModel
        expect(instance).to.be.a(_.InvoiceCcToListItemViewModel);
      });
