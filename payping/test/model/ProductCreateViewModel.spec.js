...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductCreateViewModel();
      });

      it('should create an instance of ProductCreateViewModel', function() {
        // TODO: update the code to test ProductCreateViewModel
        expect(instance).to.be.a(_.ProductCreateViewModel);
      });
