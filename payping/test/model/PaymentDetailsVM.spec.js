...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentDetailsVM', function() {
      beforeEach(function() {
        instance = new _.PaymentDetailsVM();
      });

      it('should create an instance of PaymentDetailsVM', function() {
        // TODO: update the code to test PaymentDetailsVM
        expect(instance).to.be.a(_.PaymentDetailsVM);
      });
      ...
      it('should have the property reqDate (base name: "reqDate")', function() {
        // TODO: update the code to test the property reqDate
        expect(instance).to.have.property('reqDate');
        // expect(instance.reqDate).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property isRequest (base name: "isRequest")', function() {
        // TODO: update the code to test the property isRequest
        expect(instance).to.have.property('isRequest');
        // expect(instance.isRequest).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property payerIdentity (base name: "payerIdentity")', function() {
        // TODO: update the code to test the property payerIdentity
        expect(instance).to.have.property('payerIdentity');
        // expect(instance.payerIdentity).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property rrn (base name: "rrn")', function() {
        // TODO: update the code to test the property rrn
        expect(instance).to.have.property('rrn');
        // expect(instance.rrn).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property wage (base name: "wage")', function() {
        // TODO: update the code to test the property wage
        expect(instance).to.have.property('wage');
        // expect(instance.wage).to.be(expectedValueLiteral);
      });

      it('should have the property ipgName (base name: "ipgName")', function() {
        // TODO: update the code to test the property ipgName
        expect(instance).to.have.property('ipgName');
        // expect(instance.ipgName).to.be(expectedValueLiteral);
      });
