...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoryMinorDetailVM', function() {
      beforeEach(function() {
        instance = new _.CategoryMinorDetailVM();
      });

      it('should create an instance of CategoryMinorDetailVM', function() {
        // TODO: update the code to test CategoryMinorDetailVM
        expect(instance).to.be.a(_.CategoryMinorDetailVM);
      });
