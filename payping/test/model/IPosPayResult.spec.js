...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IPosPayResult', function() {
      beforeEach(function() {
        instance = new _.IPosPayResult();
      });

      it('should create an instance of IPosPayResult', function() {
        // TODO: update the code to test IPosPayResult
        expect(instance).to.be.a(_.IPosPayResult);
      });

      it('should have the property itd (base name: "itd")', function() {
        // TODO: update the code to test the property itd
        expect(instance).to.have.property('itd');
        // expect(instance.itd).to.be(expectedValueLiteral);
      });
