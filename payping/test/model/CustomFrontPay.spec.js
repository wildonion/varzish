...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomFrontPay', function() {
      beforeEach(function() {
        instance = new _.CustomFrontPay();
      });

      it('should create an instance of CustomFrontPay', function() {
        // TODO: update the code to test CustomFrontPay
        expect(instance).to.be.a(_.CustomFrontPay);
      });

      it('should have the property bgImage (base name: "bgImage")', function() {
        // TODO: update the code to test the property bgImage
        expect(instance).to.have.property('bgImage');
        // expect(instance.bgImage).to.be(expectedValueLiteral);
      });

      it('should have the property themeColor (base name: "themeColor")', function() {
        // TODO: update the code to test the property themeColor
        expect(instance).to.have.property('themeColor');
        // expect(instance.themeColor).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property priceColor (base name: "priceColor")', function() {
        // TODO: update the code to test the property priceColor
        expect(instance).to.have.property('priceColor');
        // expect(instance.priceColor).to.be(expectedValueLiteral);
      });

      it('should have the property backImageType (base name: "backImageType")', function() {
        // TODO: update the code to test the property backImageType
        expect(instance).to.have.property('backImageType');
        // expect(instance.backImageType).to.be(expectedValueLiteral);
      });
