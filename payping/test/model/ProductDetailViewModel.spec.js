...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductDetailViewModel();
      });

      it('should create an instance of ProductDetailViewModel', function() {
        // TODO: update the code to test ProductDetailViewModel
        expect(instance).to.be.a(_.ProductDetailViewModel);
      });
