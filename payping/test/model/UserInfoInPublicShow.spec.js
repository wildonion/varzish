...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserInfoInPublicShow', function() {
      beforeEach(function() {
        instance = new _.UserInfoInPublicShow();
      });

      it('should create an instance of UserInfoInPublicShow', function() {
        // TODO: update the code to test UserInfoInPublicShow
        expect(instance).to.be.a(_.UserInfoInPublicShow);
      });
