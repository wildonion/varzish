...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSendReminderResponseViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceSendReminderResponseViewModel();
      });

      it('should create an instance of InvoiceSendReminderResponseViewModel', function() {
        // TODO: update the code to test InvoiceSendReminderResponseViewModel
        expect(instance).to.be.a(_.InvoiceSendReminderResponseViewModel);
      });
