...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateMultiRequestViewModel', function() {
      beforeEach(function() {
        instance = new _.CreateMultiRequestViewModel();
      });

      it('should create an instance of CreateMultiRequestViewModel', function() {
        // TODO: update the code to test CreateMultiRequestViewModel
        expect(instance).to.be.a(_.CreateMultiRequestViewModel);
      });
