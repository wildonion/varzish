...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceCcToDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceCcToDetailViewModel();
      });

      it('should create an instance of InvoiceCcToDetailViewModel', function() {
        // TODO: update the code to test InvoiceCcToDetailViewModel
        expect(instance).to.be.a(_.InvoiceCcToDetailViewModel);
      });
