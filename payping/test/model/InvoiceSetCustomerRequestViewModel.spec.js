...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceSetCustomerRequestViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceSetCustomerRequestViewModel();
      });

      it('should create an instance of InvoiceSetCustomerRequestViewModel', function() {
        // TODO: update the code to test InvoiceSetCustomerRequestViewModel
        expect(instance).to.be.a(_.InvoiceSetCustomerRequestViewModel);
      });
