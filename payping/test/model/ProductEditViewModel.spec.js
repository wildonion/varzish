...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductEditViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductEditViewModel();
      });

      it('should create an instance of ProductEditViewModel', function() {
        // TODO: update the code to test ProductEditViewModel
        expect(instance).to.be.a(_.ProductEditViewModel);
      });
