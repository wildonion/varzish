...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceTemplateSchulderIndexViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceTemplateSchulderIndexViewModel();
      });

      it('should create an instance of InvoiceTemplateSchulderIndexViewModel', function() {
        // TODO: update the code to test InvoiceTemplateSchulderIndexViewModel
        expect(instance).to.be.a(_.InvoiceTemplateSchulderIndexViewModel);
      });
