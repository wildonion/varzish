...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressBookListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.AddressBookListItemViewModel();
      });

      it('should create an instance of AddressBookListItemViewModel', function() {
        // TODO: update the code to test AddressBookListItemViewModel
        expect(instance).to.be.a(_.AddressBookListItemViewModel);
      });
