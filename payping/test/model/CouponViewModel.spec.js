...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponViewModel', function() {
      beforeEach(function() {
        instance = new _.CouponViewModel();
      });

      it('should create an instance of CouponViewModel', function() {
        // TODO: update the code to test CouponViewModel
        expect(instance).to.be.a(_.CouponViewModel);
      });
