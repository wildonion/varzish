...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceListItemViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceListItemViewModel();
      });

      it('should create an instance of InvoiceListItemViewModel', function() {
        // TODO: update the code to test InvoiceListItemViewModel
        expect(instance).to.be.a(_.InvoiceListItemViewModel);
      });
