...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponCreateViewModel', function() {
      beforeEach(function() {
        instance = new _.CouponCreateViewModel();
      });

      it('should create an instance of CouponCreateViewModel', function() {
        // TODO: update the code to test CouponCreateViewModel
        expect(instance).to.be.a(_.CouponCreateViewModel);
      });
