...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SocialUserInfoExtraViewModel', function() {
      beforeEach(function() {
        instance = new _.SocialUserInfoExtraViewModel();
      });

      it('should create an instance of SocialUserInfoExtraViewModel', function() {
        // TODO: update the code to test SocialUserInfoExtraViewModel
        expect(instance).to.be.a(_.SocialUserInfoExtraViewModel);
      });
