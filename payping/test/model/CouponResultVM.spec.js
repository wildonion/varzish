...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponResultVM', function() {
      beforeEach(function() {
        instance = new _.CouponResultVM();
      });

      it('should create an instance of CouponResultVM', function() {
        // TODO: update the code to test CouponResultVM
        expect(instance).to.be.a(_.CouponResultVM);
      });
      ...
      it('should have the property newAmount (base name: "newAmount")', function() {
        // TODO: update the code to test the property newAmount
        expect(instance).to.have.property('newAmount');
        // expect(instance.newAmount).to.be(expectedValueLiteral);
      });
