...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PayDirectVM', function() {
      beforeEach(function() {
        instance = new _.PayDirectVM();
      });

      it('should create an instance of PayDirectVM', function() {
        // TODO: update the code to test PayDirectVM
        expect(instance).to.be.a(_.PayDirectVM);
      });
