...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CodeVM', function() {
      beforeEach(function() {
        instance = new _.CodeVM();
      });

      it('should create an instance of CodeVM', function() {
        // TODO: update the code to test CodeVM
        expect(instance).to.be.a(_.CodeVM);
      });
