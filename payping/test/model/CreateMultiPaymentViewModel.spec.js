...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateMultiPaymentViewModel', function() {
      beforeEach(function() {
        instance = new _.CreateMultiPaymentViewModel();
      });

      it('should create an instance of CreateMultiPaymentViewModel', function() {
        // TODO: update the code to test CreateMultiPaymentViewModel
        expect(instance).to.be.a(_.CreateMultiPaymentViewModel);
      });
