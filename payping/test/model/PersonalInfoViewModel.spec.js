...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PersonalInfoViewModel', function() {
      beforeEach(function() {
        instance = new _.PersonalInfoViewModel();
      });

      it('should create an instance of PersonalInfoViewModel', function() {
        // TODO: update the code to test PersonalInfoViewModel
        expect(instance).to.be.a(_.PersonalInfoViewModel);
      });
