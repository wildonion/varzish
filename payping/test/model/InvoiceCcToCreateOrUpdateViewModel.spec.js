...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceCcToCreateOrUpdateViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceCcToCreateOrUpdateViewModel();
      });

      it('should create an instance of InvoiceCcToCreateOrUpdateViewModel', function() {
        // TODO: update the code to test InvoiceCcToCreateOrUpdateViewModel
        expect(instance).to.be.a(_.InvoiceCcToCreateOrUpdateViewModel);
      });
