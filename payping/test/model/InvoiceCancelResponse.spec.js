...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceCancelResponse', function() {
      beforeEach(function() {
        instance = new _.InvoiceCancelResponse();
      });

      it('should create an instance of InvoiceCancelResponse', function() {
        // TODO: update the code to test InvoiceCancelResponse
        expect(instance).to.be.a(_.InvoiceCancelResponse);
      });
