...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvoiceItemDetailViewModel', function() {
      beforeEach(function() {
        instance = new _.InvoiceItemDetailViewModel();
      });

      it('should create an instance of InvoiceItemDetailViewModel', function() {
        // TODO: update the code to test InvoiceItemDetailViewModel
        expect(instance).to.be.a(_.InvoiceItemDetailViewModel);
      });
