...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BaseTransactionReport', function() {
      beforeEach(function() {
        instance = new _.BaseTransactionReport();
      });

      it('should create an instance of BaseTransactionReport', function() {
        // TODO: update the code to test BaseTransactionReport
        expect(instance).to.be.a(_.BaseTransactionReport);
      });
