...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddPersonalinfoVm', function() {
      beforeEach(function() {
        instance = new _.AddPersonalinfoVm();
      });

      it('should create an instance of AddPersonalinfoVm', function() {
        // TODO: update the code to test AddPersonalinfoVm
        expect(instance).to.be.a(_.AddPersonalinfoVm);
      });
      ...
      it('should have the property localPhone (base name: "localPhone")', function() {
        // TODO: update the code to test the property localPhone
        expect(instance).to.have.property('localPhone');
        // expect(instance.localPhone).to.be(expectedValueLiteral);
      });
