...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnBlockMoneyViewModel', function() {
      beforeEach(function() {
        instance = new _.UnBlockMoneyViewModel();
      });

      it('should create an instance of UnBlockMoneyViewModel', function() {
        // TODO: update the code to test UnBlockMoneyViewModel
        expect(instance).to.be.a(_.UnBlockMoneyViewModel);
      });
