...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductBuyerViewModel', function() {
      beforeEach(function() {
        instance = new _.ProductBuyerViewModel();
      });

      it('should create an instance of ProductBuyerViewModel', function() {
        // TODO: update the code to test ProductBuyerViewModel
        expect(instance).to.be.a(_.ProductBuyerViewModel);
      });
      ...
      it('should have the property payDateDisplay (base name: "payDateDisplay")', function() {
        // TODO: update the code to test the property payDateDisplay
        expect(instance).to.have.property('payDateDisplay');
        // expect(instance.payDateDisplay).to.be(expectedValueLiteral);
      });

      it('should have the property phoneVM (base name: "phoneVM")', function() {
        // TODO: update the code to test the property phoneVM
        expect(instance).to.have.property('phoneVM');
        // expect(instance.phoneVM).to.be(expectedValueLiteral);
      });
