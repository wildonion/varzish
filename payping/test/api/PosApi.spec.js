...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new _.PosApi();
  });

  describe('(package)', function() {
    describe('PosApi', function() {
      describe('posCreatePayment', function() {
        it('should call posCreatePayment successfully', function(done) {
          // TODO: uncomment, update parameter values for posCreatePayment call and complete the assertions
          /*
          var opts = {};
          ...
          instance.posCreatePayment(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(_.IPosPayResult);
            expect(data.itd).to.be.a('number');
            expect(data.itd).to.be(0);
