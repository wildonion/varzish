...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new _.WithdrawApi();
  });

  describe('(package)', function() {
    describe('WithdrawApi', function() {
      describe('withdrawCreate', function() {
        it('should call withdrawCreate successfully', function(done) {
          // TODO: uncomment, update parameter values for withdrawCreate call and complete the assertions
          /*
          var amount = 56;

          instance.withdrawCreate(amount, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(_.WithdrawResult);
      ...
      describe('withdrawDetails', function() {
        it('should call withdrawDetails successfully', function(done) {
          // TODO: uncomment, update parameter values for withdrawDetails call and complete the assertions
          /*
          var code = "code_example";

          instance.withdrawDetails(code, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(_.WithdrawDetailsViewModel);
