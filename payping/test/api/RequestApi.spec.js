...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new _.RequestApi();
  });

  describe('(package)', function() {
    describe('RequestApi', function() {
      describe('requestCancelRequest', function() {
        it('should call requestCancelRequest successfully', function(done) {
          // TODO: uncomment, update parameter values for requestCancelRequest call
          /*
          var code = "code_example";

          instance.requestCancelRequest(code, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('requestCreateMultiRequest', function() {
        it('should call requestCreateMultiRequest successfully', function(done) {
          // TODO: uncomment, update parameter values for requestCreateMultiRequest call and complete the assertions
          /*
          var opts = {};
          opts.model = new _.CreateMultiRequestViewModel();
          ...
          instance.requestCreateMultiRequest(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(_.MultiRequestViewModel);
      ...
      describe('requestCreateRequest', function() {
        it('should call requestCreateRequest successfully', function(done) {
          // TODO: uncomment, update parameter values for requestCreateRequest call and complete the assertions
          /*
          var opts = {};
          opts.model = new _.CreateRequestViewModel();
          opts.model.name = "";
          opts.model.amount = 0;
          ...
          instance.requestCreateRequest(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(_.RequestResult);
            expect(data.code).to.be.a('string');
            expect(data.code).to.be("");
      ...
      describe('requestSendReminder', function() {
        it('should call requestSendReminder successfully', function(done) {
          // TODO: uncomment, update parameter values for requestSendReminder call
          /*
          var code = "code_example";

          instance.requestSendReminder(code, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
