...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new _.UploadApi();
  });

  describe('(package)', function() {
    describe('UploadApi', function() {
      describe('uploadInvoiceAttachment', function() {
        it('should call uploadInvoiceAttachment successfully', function(done) {
          // TODO: uncomment, update parameter values for uploadInvoiceAttachment call
          /*
          var file = "/path/to/file.txt";

          instance.uploadInvoiceAttachment(file, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('uploadItem', function() {
        it('should call uploadItem successfully', function(done) {
          // TODO: uncomment, update parameter values for uploadItem call
          /*
          var file = "/path/to/file.txt";

          instance.uploadItem(file, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('uploadProfilePic', function() {
        it('should call uploadProfilePic successfully', function(done) {
          // TODO: uncomment, update parameter values for uploadProfilePic call
          /*
          var file = "/path/to/file.txt";

          instance.uploadProfilePic(file, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
